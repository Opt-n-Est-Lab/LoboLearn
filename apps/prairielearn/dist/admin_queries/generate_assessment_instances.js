...
export default async function ({ assessment_id, mode, }) {
    return await runInTransactionAsync(async () => {
        ...
        if (assessment.group_work)
            columns.splice(0, 0, 'group_name');
        const rows = await mapSeries(users, async (user) => ({
            ...user,
...
//# sourceMappingURL=generate_assessment_instances.js.map