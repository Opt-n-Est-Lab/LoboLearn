...
router.get('/:unsafe_assessment_instance_id(\\d+)', asyncHandler(async (req, res) => {
...
router.get('/:unsafe_assessment_instance_id(\\d+)/instance_questions', asyncHandler(async (req, res) => {
...
router.get('/:unsafe_assessment_instance_id(\\d+)/submissions', asyncHandler(async (req, res) => {
...
router.get('/:unsafe_assessment_instance_id(\\d+)/log', asyncHandler(async (req, res) => {
    ...
    const logs = await assessment.selectAssessmentInstanceLog(result.rows[0].assessment_instance_id, true);
