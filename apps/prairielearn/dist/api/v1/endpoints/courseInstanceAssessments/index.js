...
router.get('/:unsafe_assessment_id(\\d+)', asyncHandler(async (req, res) => {
    const result = await sqldb.queryOneRowAsync(sql.select_assessments, {
        course_instance_id: res.locals.course_instance.id,
...
router.get('/:unsafe_assessment_id(\\d+)/assessment_instances', asyncHandler(async (req, res) => {
...
router.get('/:unsafe_assessment_id(\\d+)/assessment_access_rules', asyncHandler(async (req, res) => {
