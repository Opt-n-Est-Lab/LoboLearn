 ...
 * administrator.
 */
function assertNotExampleCourse(req, res, next) {
...
// ROUTES
router.use('/course_instances/:course_instance_id(\\d+)/assessments', (await import('./endpoints/courseInstanceAssessments/index.js')).default);
router.use('/course_instances/:course_instance_id(\\d+)/assessment_instances', authzHasCourseInstanceView, (await import('./endpoints/courseInstanceAssessmentInstances/index.js')).default);
router.use('/course_instances/:course_instance_id(\\d+)/submissions', authzHasCourseInstanceView, (await import('./endpoints/courseInstanceSubmissions/index.js')).default);
router.use('/course_instances/:course_instance_id(\\d+)/gradebook', authzHasCourseInstanceView, (await import('./endpoints/courseInstanceGradebook/index.js')).default);
router.use('/course_instances/:course_instance_id(\\d+)/course_instance_access_rules', (await import('./endpoints/courseInstanceAccessRules/index.js')).default);
