...
export function ChangeIdButton({ label, currentValue, otherValues, extraHelpText, csrfToken, action, }) {
    ...
    <button
      ...
      data-bs-content="${escapeHtml(ChangeIdForm({ id, label, currentValue, extraHelpText, csrfToken, action }))}"
    >
...
function ChangeIdForm({ id, label, currentValue, extraHelpText, csrfToken, action, }) {
    return html `
...
//# sourceMappingURL=ChangeIdButton.html.js.map