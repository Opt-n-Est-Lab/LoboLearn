...
export function CourseRequestsTable({ rows, institutions, coursesRoot, showAll, csrfToken, urlPrefix, }) {
        ...
        return html `
            ...
            ? html `
                          <button
                            ...
                            data-bs-content="${escapeHtml(CourseRequestDenyForm({
                request: row,
                csrfToken,
            }))}"
                          >
                          ...
                          <button
                            ...
                            data-bs-content="${escapeHtml(CourseRequestApproveForm({
                request: row,
                institutions,
                coursesRoot,
                csrfToken,
...
function CourseRequestApproveForm({ request, institutions, coursesRoot, csrfToken, }) {
...
function CourseRequestDenyForm({ request, csrfToken, }) {
    return html `
    <form method="POST">
      <input type="hidden" name="__csrf_token" value="${csrfToken}" />
...
function CourseRequestStatusIcon({ status }) {
    switch (status) {
        case 'pending':
...
//# sourceMappingURL=CourseRequestsTable.html.js.map