...
export function HeadContents(titleOptions) {
    return html `
    <meta charset="utf-8" />
 ...
 */
function getTitle({ resLocals, pageTitle, pageNote }) {
    if (config.titleOverride) {
        return config.titleOverride;
    }
    const { assessment, assessment_set, instance_question_info, course, course_instance, navPage, navSubPage, navbarType, } = resLocals;
    const navTrace = [];
...
//# sourceMappingURL=HeadContents.html.js.map