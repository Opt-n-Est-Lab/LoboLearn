...
export function InsufficientCoursePermissionsCardPage({ resLocals, courseOwners, pageTitle, requiredPermissions, }) {
    return html `
    <!doctype html>
    <html lang="en">
      <head>
...
export function InsufficientCoursePermissionsCard({ courseOwners, pageTitle, requiredPermissions, }) {
...
//# sourceMappingURL=InsufficientCoursePermissionsCard.js.map