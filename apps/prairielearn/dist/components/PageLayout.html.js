...
export function PageLayout({ resLocals, pageTitle, navContext, options = {}, headContent, preContent, content, postContent, }) {
    ...
    if (resLocals.has_enhanced_navigation) {
        ...
        const sideNavEnabled = resLocals.course && navContext.type !== 'student' && navContext.type !== 'public';
      ...
      <html lang="en">
        ...
        >
          <div
            id="app-container"
            class="${clsx('app-container', sideNavEnabled && 'side-nav-enabled', !sideNavExpanded && 'collapsed')}"
          >
            ...
            : ''}
                ...
                <main
                  id="content"
                  class="${clsx(options.fullWidth ? 'container-fluid' : 'container', marginBottom && 'mb-4', options.fullHeight && 'flex-grow-1', 'pt-3', sideNavEnabled && 'px-3')}"
                >
                  ${content}
                </main>
                ${postContent}
...
//# sourceMappingURL=PageLayout.html.js.map