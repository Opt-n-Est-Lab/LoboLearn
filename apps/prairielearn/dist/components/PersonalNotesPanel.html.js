...
export function PersonalNotesPanel({ fileList, courseInstanceId, assessment_instance, authz_result, variantId, allowNewUploads = true, csrfToken, context, }) {
    return html `
...
function AttachFileForm({ variantId, csrfToken }) {
    return html `
    <div>
      <button
...
function UploadTextForm({ variantId, csrfToken }) {
    return html `
    <div>
      <button
        class="btn btn-xs btn-secondary"
...
function DeletePersonalNoteButton({ file, variantId, csrfToken, }) {
...
//# sourceMappingURL=PersonalNotesPanel.html.js.map