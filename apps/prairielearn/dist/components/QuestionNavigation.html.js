...
export function QuestionNavSideGroup({ urlPrefix, prevInstanceQuestionId, nextInstanceQuestionId, sequenceLocked, prevGroupRolePermissions, nextGroupRolePermissions, advanceScorePerc, userGroupRoles, }) {
    return html `
...
export function QuestionNavSideButton({ instanceQuestionId, sequenceLocked, urlPrefix, whichButton, groupRolePermissions, advanceScorePerc, userGroupRoles, }) {
    const { buttonId, buttonLabel } = whichButton === 'next'
...
//# sourceMappingURL=QuestionNavigation.html.js.map