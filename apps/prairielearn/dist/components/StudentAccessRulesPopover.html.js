...
export function StudentAccessRulesPopover({ accessRules }) {
    return html `
    <button
      type="button"
...
function StudentAccessRulesPopoverContent({ accessRules }) {
    return html `
    <table class="table" aria-label="Access details">
      ...
      ${accessRules.map((accessRule) => html `
          <tr>
...
//# sourceMappingURL=StudentAccessRulesPopover.html.js.map