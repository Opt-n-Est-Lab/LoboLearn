...
export function CourseSyncErrorsAndWarnings({ authz_data, course, urlPrefix, }) {
...
export function QuestionSyncErrorsAndWarnings({ authz_data, question, course, urlPrefix, }) {
    return SyncErrorsAndWarnings({
        authz_data,
        exampleCourse: course.example_course,
...
export function CourseInstanceSyncErrorsAndWarnings({ authz_data, courseInstance, course, urlPrefix, }) {
    return SyncErrorsAndWarnings({
        authz_data,
        exampleCourse: course.example_course,
...
export function AssessmentSyncErrorsAndWarnings({ authz_data, assessment, courseInstance, course, urlPrefix, }) {
    return SyncErrorsAndWarnings({
        authz_data,
        exampleCourse: course.example_course,
...
function SyncErrorsAndWarnings({ authz_data, exampleCourse, syncErrors, syncWarnings, fileEditUrl, context, }) {
...
//# sourceMappingURL=SyncErrorsAndWarnings.html.js.map