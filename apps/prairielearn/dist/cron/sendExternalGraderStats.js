...
export async function run() {
    ...
    const { count, delta_total, delta_submitted_at, delta_received_at, delta_started_at, delta_finished_at, delta_final, max_total, max_submitted_at, max_received_at, max_started_at, max_finished_at, max_final, } = result.rows[0];
...
//# sourceMappingURL=sendExternalGraderStats.js.map