...
export async function run() {
    ...
    for (const workspace of workspaces) {
        ...
        await workspaceUtils.updateWorkspaceMessage(workspace.id, `WARNING: This workspace will stop in < ${time_to_timeout_min} min. Click "Reboot" to keep working.`);
    }
}
//# sourceMappingURL=workspaceTimeoutWarn.js.map