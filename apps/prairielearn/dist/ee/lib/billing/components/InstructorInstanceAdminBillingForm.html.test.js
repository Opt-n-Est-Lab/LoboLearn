...
describe('instructorInstanceAdminBillingState', () => {
    ...
    it('warns when disabling student billing with excess enrollments', () => {
        ...
        assert.match(state.studentBillingAlert?.message ?? '', /To disable student billing, first remove excess enrollments./);
    });
...
//# sourceMappingURL=InstructorInstanceAdminBillingForm.html.test.js.map