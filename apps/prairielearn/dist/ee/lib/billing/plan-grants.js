import {} from 'express';
import { CourseInstanceSchema, InstitutionSchema, QuestionSchema, UserSchema, } from '../../../lib/db-types.js';
import { features } from '../../../lib/features/index.js';
import { getPlanGrantsForPartialContexts, getPlanNamesFromPlanGrants, getRequiredPlansForCourseInstance, planGrantsMatchFeatures, } from '../../lib/billing/plans.js';
import { planGrantsMatchPlanFeatures } from './plans-types.js';
function userHasRole(authz_data) {
...
export async function checkPlanGrantsForLocals(locals) {
...
export async function checkPlanGrants({ institution, course_instance, authz_data, }) {
...
export async function checkPlanGrantsForQuestion(res) {
    if (userHasRole(res)) {
        return true;
    }
    ...
    const shouldCheck = await features.enabledFromLocals('enforce-plan-grants-for-questions', res.locals);
    if (!shouldCheck) {
        return true;
    }
...
//# sourceMappingURL=plan-grants.js.map