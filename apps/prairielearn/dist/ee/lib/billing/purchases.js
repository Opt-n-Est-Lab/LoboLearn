...
import { CourseInstanceSchema, CourseSchema, StripeCheckoutSessionSchema, } from '../../../lib/db-types.js';
...
export async function getPurchasesForUser(user_id) {
    ...
    const completedPurchases = allPurchases.filter((purchase) => purchase.stripe_checkout_session.data.status === 'complete');
