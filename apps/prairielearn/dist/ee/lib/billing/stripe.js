...
export async function getOrCreateStripeCustomerId(user_id, { name }) {
...
function stripeProductCacheKey(id) {
...
export async function clearStripeProductCache(id) {
    const cacheKey = stripeProductCacheKey(id);
    await cache.del(cacheKey);
}
export async function getDefaultPriceForStripeProduct(id) {
...
export async function getPriceForPlan(plan) {
 ...
 */
export async function getPricesForPlans(plans) {
    const prices = {};
