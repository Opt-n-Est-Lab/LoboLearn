...
import { getEnrollmentCountsForCourse, getEnrollmentCountsForCourseInstance, getEnrollmentCountsForInstitution, } from './enrollment.js';
...
describe('getEnrollmentCountsForInstitution', () => {
    ...
    it('returns correct counts across course instances', async () => {
        ...
        const courseInstance = await queryRow("INSERT INTO course_instances (course_id, display_timezone) VALUES (1, 'UTC') RETURNING *", {}, CourseInstanceSchema);
