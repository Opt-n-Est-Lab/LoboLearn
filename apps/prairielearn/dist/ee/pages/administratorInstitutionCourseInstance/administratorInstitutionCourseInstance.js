...
import { getPlanGrantsForCourseInstance, reconcilePlanGrantsForCourseInstance, } from '../../lib/billing/plans.js';
...
async function selectCourseInstanceAndCourseInInstitution({ institution_id, unsafe_course_instance_id, }) {
    return await queryRow(sql.select_course_and_instance, {
        institution_id,
...
router.get('/', asyncHandler(async (req, res) => {
    ...
    res.send(AdministratorInstitutionCourseInstance({
        institution,
        course,
        course_instance,
        planGrants,
...
router.post('/', asyncHandler(async (req, res) => {
    ...
    if (req.body.__action === 'update_enrollment_limit') {
        ...
        await reconcilePlanGrantsForCourseInstance(course_instance.id, desiredPlans, res.locals.authn_user.user_id);
...
//# sourceMappingURL=administratorInstitutionCourseInstance.js.map