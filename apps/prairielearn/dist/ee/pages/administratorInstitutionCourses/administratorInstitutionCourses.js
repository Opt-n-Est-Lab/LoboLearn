...
router.get('/', asyncHandler(async (req, res) => {
    ...
    const courses = await queryRows(sql.select_courses, { institution_id: req.params.institution_id }, CourseSchema);
    res.send(AdministratorInstitutionCourses({ institution, courses, resLocals: res.locals }));
}));
export default router;
//# sourceMappingURL=administratorInstitutionCourses.js.map