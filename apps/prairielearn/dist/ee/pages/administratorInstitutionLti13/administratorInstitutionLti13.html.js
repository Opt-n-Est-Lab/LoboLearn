...
export function AdministratorInstitutionLti13({ institution, lti13Instances, instance, resLocals, platform_defaults, canonicalHost, }) {
    return PageLayout({
        resLocals: {
            ...resLocals,
            institution,
...
function LTI13Instance(instance, resLocals, platform_defaults, canonicalHost) {
    if (instance) {
        return html `
...
//# sourceMappingURL=administratorInstitutionLti13.html.js.map