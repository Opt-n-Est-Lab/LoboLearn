...
import { getInstitution, getInstitutionAuthenticationProviders, getInstitutionSamlProvider, getSupportedAuthenticationProviders, } from '../../lib/institution.js';
...
router.post('/', asyncHandler(async (req, res) => {
    ...
    const supportedAuthenticationProviderIds = new Set(supportedAuthenticationProviders.map((p) => p.id));
...
router.get('/', asyncHandler(async (req, res) => {
    ...
    const institutionAuthenticationProviders = await getInstitutionAuthenticationProviders(req.params.institution_id);
    res.send(AdministratorInstitutionSso({
...
//# sourceMappingURL=administratorInstitutionSso.js.map