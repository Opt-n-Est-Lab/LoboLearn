...
import { InstitutionAdministratorSchema, UserSchema, } from '../../../lib/db-types.js';
export const InstitutionAdminAdminsRowSchema = z.object({
    user: UserSchema,
    institution_administrator: InstitutionAdministratorSchema,
});
export function InstitutionAdminAdmins({ institution, rows, uidsLimit, resLocals, }) {
    return PageLayout({
        resLocals: {
            ...resLocals,
            institution,
...
function AddAdminsModal({ uidsLimit, csrfToken }) {
    return Modal({
        id: 'addAdminsModal',
...
function RemoveAdminModal({ csrfToken }) {
    return Modal({
        id: 'removeAdminModal',
...
//# sourceMappingURL=institutionAdminAdmins.html.js.map