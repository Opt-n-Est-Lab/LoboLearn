...
const examplePrompts = [
    {
        ...
        prompt: 'Write a multiple choice question asking the user to choose the median of 5 random numbers between 1 and 100. Display all numbers to the user, and ask them to choose the median.',
    },
    {
        id: 'Multiply random integers',
        prompt: 'Write a question that asks the user to multiply two integers. You should randomly generate two integers A and B, display them to the user, and then ask the user to provide the product C = A * B.',
    },
    {
        id: 'Answer to Ultimate Question',
        prompt: 'Write a question asking "What Is The Answer to the Ultimate Question of Life, the Universe, and Everything?".',
    },
    {
...
export function InstructorAIGenerateDrafts({ resLocals, drafts, }) {
            ...
            ? html `
                    ...
                    <div class="mb-3">
                      ...
                      <select id="user-prompt-example" class="form-select">
                        <option value=""></option>
                        ${examplePrompts.map((question) => html `<option value="${question.id}" data-prompt="${question.prompt}">
                              ${question.id}
                            </option>`)}
                      </select>
                    </div>
      ...
      ${hasDrafts
            ...
            <div class="card">
              <div class="table-responsive">
                ...
                ? html `&mdash;`
                : formatDate(row.draft_question_metadata.created_at, resLocals.course.display_timezone)}
                          </td>
...
export function GenerationFailure({ urlPrefix, jobSequenceId, }) {
    return html `
...
//# sourceMappingURL=instructorAiGenerateDrafts.html.js.map