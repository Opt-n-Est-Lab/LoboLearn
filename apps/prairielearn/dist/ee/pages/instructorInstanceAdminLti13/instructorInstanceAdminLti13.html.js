...
import {} from '../../lib/lti13.js';
export const AssessmentRowSchema = AssessmentSchema.merge(AssessmentSetSchema.pick({ abbreviation: true, name: true, color: true })).extend({
    start_new_assessment_group: z.boolean(),
    assessment_group_heading: AssessmentSetSchema.shape.heading,
    label: z.string(),
});
export function InstructorInstanceAdminLti13({ resLocals, instance, instances, assessments, lineitems, }) {
        ...
        <div class="card-body">
          <div class="row">
            ...
            return html `
              ...
              Created at:
              ${formatDateYMDHM(instance.lti13_course_instance.created_at, resLocals.course_instance.display_timezone)}
            </div>
            <div class="col-10">
...
function LinkedAssessments({ resLocals, lms_name, assessments, lineitems, }) {
      ...
      <table class="table table-sm table-hover">
        ...
        return html `
            ...
            : html `
                ...
                <td class="align-middle">
                  ${lineitems_linked.map((i) => LineItem(i, resLocals.course_instance.display_timezone))}
                </td>
              </tr>
            `;
    })}
...
function LineItem(item, timezone) {
    return html `
...
export function LineitemsInputs(lineitems) {
...
//# sourceMappingURL=instructorInstanceAdminLti13.html.js.map