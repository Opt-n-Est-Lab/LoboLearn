...
export function Lti13CourseNavigationInstructor({ courseName, resLocals, courses, lti13_instance_id, }) {
    return html `
    <!doctype html>
    <html lang="en">
      <head>
...
export function Lti13CourseNavigationNotReady({ courseName, resLocals, ltiRoles, }) {
    return html `
    <!doctype html>
    <html lang="en">
      <head>
...
export function Lti13CourseNavigationDone({ resLocals, lti13_instance_id, }) {
    return html `
    <!doctype html>
    <html lang="en">
      <head>
...
//# sourceMappingURL=lti13CourseNavigation.html.js.map