...
import { getStripeCheckoutSessionByStripeObjectId, markStripeCheckoutSessionCompleted, updateStripeCheckoutSessionData, } from '../../models/stripe-checkout-sessions.js';
...
function constructEvent(req) {
    ...
    try {
        return stripe.webhooks.constructEvent(req.body, req.headers['stripe-signature'], config.stripeWebhookSigningSecret);
    }
    catch (err) {
