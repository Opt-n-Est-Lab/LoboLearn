import { z } from 'zod';
import { ConfigLoader, makeFileConfigSource, makeImdsConfigSource, makeSecretsManagerConfigSource, } from '@prairielearn/config';
...
export async function loadConfig(paths) {
    ...
    if (config.questionRenderCacheType !== null) {
        logger.warn('The field "questionRenderCacheType" is deprecated. Please move the cache type configuration to the field "cacheType".');
...
export function setLocalsFromConfig(locals) {
