...
export async function setQuestionCopyTargets(res) {
...
export async function copyQuestionBetweenCourses(res, { fromCourse, toCourseId, question, }) {
    ...
    res.redirect(`${res.locals.plainUrlPrefix}/course/${params.to_course_id}/file_transfer/${result.rows[0].id}`);
}
//# sourceMappingURL=copy-question.js.map