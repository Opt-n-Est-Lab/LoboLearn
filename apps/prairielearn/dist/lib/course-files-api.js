...
import { courseFilesRouter } from '../api/trpc/index.js';
...
let cachedCourseFilesClient = null;
export function getCourseFilesClient() {
    cachedCourseFilesClient ??= createTRPCProxyClient({
        links: [getCourseFilesLink()],
    });
    return cachedCourseFilesClient;
}
//# sourceMappingURL=course-files-api.js.map