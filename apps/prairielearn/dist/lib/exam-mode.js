...
import { EnumModeReasonSchema, EnumModeSchema, } from './db-types.js';
export async function getModeForRequest(req, res) {
...
export async function ipToMode({ ip, date, authn_user_id, }) {
    return await callRow('ip_to_mode', [ip, date, authn_user_id], z.object({ mode: EnumModeSchema, mode_reason: EnumModeReasonSchema }));
}
//# sourceMappingURL=exam-mode.js.map