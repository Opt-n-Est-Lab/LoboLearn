/**
 * This is a simplified version of faker.js that only includes the functions that we actually use in PrairieLearn. Name lists are credited to:
 * https://github.com/faker-js/faker/tree/1a94e96797990586dcd0e1d23051741a0556de80/src/locales/en
 */
const firstNameList = [
    'Aaliyah',
    'Aaron',
...
export function fakeExampleEmail({ firstName, lastName }) {
...
export function fakeNameAndEmail() {
    const firstName = fakeFirstName();
    const lastName = fakeLastName();
    return {
        name: `${firstName} ${Math.random() < 0.2 ? `${fakeMiddleName()} ` : ''}${lastName}`,
        email: fakeExampleEmail({ firstName, lastName }),
    };
}
