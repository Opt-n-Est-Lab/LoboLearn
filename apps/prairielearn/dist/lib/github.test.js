...
describe('Github library', () => {
    describe('httpPrefixforCourseRepo', () => {
        it('Converts to HTTPS prefix when repo has proper format', async () => {
            assert.equal(httpPrefixForCourseRepo('git@github.com:username/repo.git'), 'https://github.com/username/repo');
            assert.equal(httpPrefixForCourseRepo('git@github.com:username2/repo-other.git'), 'https://github.com/username2/repo-other');
            assert.equal(httpPrefixForCourseRepo('git@github.com:username3/repo-yet-another'), 'https://github.com/username3/repo-yet-another');
            assert.equal(httpPrefixForCourseRepo('git@github.com:onemore/repository.git/'), 'https://github.com/onemore/repository');
        });
