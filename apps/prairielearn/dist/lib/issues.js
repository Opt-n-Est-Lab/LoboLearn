 ...
 * Inserts an issue.
 */
export async function insertIssue({ variantId, studentMessage, instructorMessage, manuallyReported, courseCaused, courseData, systemData, userId, authnUserId, }) {
 ...
 */
export async function writeCourseIssues(courseIssues, variant, user_id, authn_user_id, studentMessage, courseData) {
...
export async function reportIssueFromForm(req, res, studentSubmission = false) {
