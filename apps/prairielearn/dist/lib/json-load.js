...
export async function readJSON(jsonFilename) {
    ...
    try {
        ...
        throw new Error(`Error in JSON file format: ${jsonFilename} (line ${e.row}, column ${e.column})\n${e.name}: ${e.message}`);
    }
}
/**
...
export function validateJSON(json, schema) {
    ...
    if (!valid) {
        throw new Error(`JSON validation error: ${ajv.errorsText(validate.errors)}\nError details:\n${JSON.stringify(validate.errors, null, 2)}`);
    }
}
/**
...
//# sourceMappingURL=json-load.js.map