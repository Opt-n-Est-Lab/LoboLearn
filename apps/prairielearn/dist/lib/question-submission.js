...
export async function processSubmission(req, res, options = {}) {
    ...
    if (req.body.__action === 'grade') {
        ...
        await saveAndGradeSubmission(submission, variant, res.locals.question, res.locals.course, overrideRateLimits);
...
//# sourceMappingURL=question-submission.js.map