...
describe('uri-util', () => {
    describe('encodePath', () => {
        ...
        it('handles simple file paths', () => {
            ...
            assert.equal(encodePath('dir/with/multiple/names/file.py'), 'dir/with/multiple/names/file.py');
        ...
        it('encodes same characters as encodeURLComponent except /', () => {
            ...
            assert.equal(encodePath("-_.!~*'();/?:@&=+$,#.json"), "-_.!~*'()%3B/%3F%3A%40%26%3D%2B%24%2C%23.json");
        });
        it('encodes ASCII non-printable characters', () => {
            assert.equal(encodePath('dir/\x00\x01\x02\x03\x04\x05\x06\x07\x08\x09\x0a\x0b\x0c\x0d\x0e\x0f.txt'), 'dir/%00%01%02%03%04%05%06%07%08%09%0A%0B%0C%0D%0E%0F.txt');
        });
...
//# sourceMappingURL=uri-util.test.js.map