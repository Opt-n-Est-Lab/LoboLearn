...
export async function authzHasCoursePreviewOrInstanceView(req, res) {
    if (!res.locals.authz_data.has_course_permission_preview &&
        ...
        throw new error.HttpStatusError(403, 'Requires either course preview access or student data view access');
    }
}
...
//# sourceMappingURL=authzHasCoursePreviewOrInstanceView.js.map