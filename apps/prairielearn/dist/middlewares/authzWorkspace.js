...
export default asyncHandler(async (req, res, next) => {
    ...
    const result = await sqldb.queryOptionalRow(sql.select_auth_data_from_workspace, { workspace_id: res.locals.workspace_id }, z.object({
        variant_id: IdSchema,
...
//# sourceMappingURL=authzWorkspace.js.map