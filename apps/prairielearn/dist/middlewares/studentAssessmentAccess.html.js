...
export function StudentAssessmentAccess({ resLocals, showClosedScore = true, showTimeLimitExpiredModal = false, userCanDeleteAssessmentInstance = false, }) {
        ...
        ? html `
                    <div class="row align-items-center">
                      <div class="col-md-3 col-sm-6">
                        Total points:
                        ${formatPoints(assessment_instance.points)}/${formatPoints(assessment_instance.max_points)}
                      </div>
                      <div class="col-md-3 col-sm-6">
...
function AssessmentStatusDescription({ assessment_instance, authz_result, extraClasses = '', }) {
    return html `
...
//# sourceMappingURL=studentAssessmentAccess.html.js.map