...
import { AlternativeGroupSchema, AssessmentQuestionSchema, AssessmentsFormatForQuestionSchema, IdSchema, QuestionSchema, TagSchema, TopicSchema, ZoneSchema, } from '../lib/db-types.js';
...
export async function selectAssessmentQuestions(assessment_id) {
    const rows = await sqldb.queryRows(sql.select_assessment_questions, { assessment_id }, AssessmentQuestionRowSchema);
    return rows;
}
//# sourceMappingURL=assessment-question.js.map