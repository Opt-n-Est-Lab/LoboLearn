 ...
 */
export async function updateCourseInstanceUsagesForSubmission({ submission_id, user_id, }) {
 ...
 */
export async function updateCourseInstanceUsagesForGradingJob({ grading_job_id, }) {
    await queryAsync(sql.update_course_instance_usages_for_external_grading, {
        grading_job_id,
    });
}
//# sourceMappingURL=course-instance-usages.js.map