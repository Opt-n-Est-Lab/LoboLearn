...
export function AdministratorAdmins({ admins, resLocals, }) {
    return PageLayout({
        resLocals,
      ...
      <div class="card mb-4">
        <div class="card-header bg-primary text-white d-flex align-items-center">
          ...
          <button
            ...
            data-bs-content="${escapeHtml(AdministratorInsertForm({
                  ...
                  <tr>
                    ...
                    <td class="align-middle">
                      <button
                        ...
                        data-bs-content="${escapeHtml(AdministratorDeleteForm({
            csrfToken: resLocals.__csrf_token,
            uid: admin.uid,
...
function AdministratorInsertForm({ csrfToken }) {
    return html `
...
function AdministratorDeleteForm({ csrfToken, userId, uid, }) {
    return html `
    <form name="add-user-form" method="POST">
...
//# sourceMappingURL=administratorAdmins.html.js.map