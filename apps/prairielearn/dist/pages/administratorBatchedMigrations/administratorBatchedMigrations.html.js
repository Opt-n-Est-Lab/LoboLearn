...
export function AdministratorBatchedMigrations({ batchedMigrations, resLocals, }) {
...
export function AdministratorBatchedMigration({ batchedMigration, recentSucceededJobs, recentFailedJobs, resLocals, }) {
    return PageLayout({
        resLocals,
        pageTitle: 'Batched migrations',
        navContext: {
            ...
            return html `
                ...
                ? html `
                        <details>
                          ...
                          <pre class="mt-3 p-3 rounded bg-dark text-white"><code>${JSON.stringify(job.data, null, 2)}</code></pre>
                        </details>
                      `
...
//# sourceMappingURL=administratorBatchedMigrations.html.js.map