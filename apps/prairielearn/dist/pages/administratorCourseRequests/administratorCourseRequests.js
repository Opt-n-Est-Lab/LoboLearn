...
import { createCourseFromRequest, selectAllCourseRequests, updateCourseRequest, } from '../../lib/course-request.js';
...
router.get('/', asyncHandler(async (req, res) => {
    ...
    res.send(AdministratorCourseRequests({
        rows,
        institutions,
...
//# sourceMappingURL=administratorCourseRequests.js.map