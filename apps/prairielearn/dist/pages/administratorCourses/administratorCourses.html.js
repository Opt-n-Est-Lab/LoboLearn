...
import { CourseSchema, InstitutionSchema } from '../../lib/db-types.js';
export const CourseWithInstitutionSchema = CourseSchema.extend({
    institution: InstitutionSchema,
});
export function AdministratorCourses({ course_requests, institutions, courses, coursesRoot, resLocals, }) {
    return PageLayout({
        resLocals,
        pageTitle: 'Courses',
        navContext: {
      ...
      <div id="courses" class="card mb-4">
        <div class="card-header bg-primary text-white d-flex align-items-center">
          ...
          <button
            ...
            data-bs-content="${escapeHtml(CourseInsertForm({
            institutions,
            csrfToken: resLocals.__csrf_token,
        }))}"
          >
                ...
                csrfToken: resLocals.__csrf_token,
                    ...
                    <td class="align-middle">
                      <button
                        ...
                        data-bs-content="${escapeHtml(CourseDeleteForm({
                id: `courseDeleteButton${course.id}`,
                course,
                csrfToken: resLocals.__csrf_token,
            }))}"
...
function CourseDeleteForm({ id, course, csrfToken, }) {
    return html `
...
function CourseInsertForm({ institutions, csrfToken, }) {
    return html `
...
function CourseUpdateColumn({ course, column_name, label, href, csrfToken, }) {
    return html `
    <td class="align-middle">
      ...
      <button
        ...
        data-bs-content="${escapeHtml(CourseUpdateColumnForm({
        course,
        column_name,
        csrfToken,
        label,
...
function CourseUpdateColumnForm({ course, column_name, csrfToken, label, }) {
    return html `
...
//# sourceMappingURL=administratorCourses.html.js.map