...
import { createCourseFromRequest, selectPendingCourseRequests, updateCourseRequest, } from '../../lib/course-request.js';
...
router.post('/', asyncHandler(async (req, res) => {
    if (req.body.__action === 'courses_insert') {
        ...
        if (req.body.confirm_short_name !== course.short_name) {
            throw new error.HttpStatusError(400, `deletion aborted: confirmation string "${req.body.confirm_short_name}" did not match expected value of "${course.short_name}"`);
        }
        await deleteCourse({
...
//# sourceMappingURL=administratorCourses.js.map