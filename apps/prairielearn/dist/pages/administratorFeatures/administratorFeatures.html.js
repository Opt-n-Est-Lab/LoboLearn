...
export function AdministratorFeatures({ features, resLocals, }) {
    return PageLayout({
        resLocals,
        pageTitle: 'Features',
        navContext: {
...
export function AdministratorFeature({ feature, featureGrants, featureInConfig, institutions, resLocals, }) {
    return PageLayout({
        resLocals,
        pageTitle: 'Features',
        navContext: {
            ...
            ? html `
              <div class="list-group list-group-flush">
                ...
                ? html `
                    ...
                    `
                : ''}
                ${featureGrants.map((featureGrant) => FeatureGrant({
                featureGrant,
...
function FeatureGrant({ featureGrant, overridden, csrfToken, }) {
    return html `
    <div
...
function AddFeatureGrantModal(props) {
    return Modal({
        title: 'Grant feature',
...
export function AddFeatureGrantModalBody({ feature, enabled, institutions, institution_id, courses, course_id, course_instances, course_instance_id, }) {
...
//# sourceMappingURL=administratorFeatures.html.js.map