...
export function AdministratorInstitutions({ institutions, availableTimezones, resLocals, }) {
    return PageLayout({
        resLocals,
      ...
      <div id="institutions" class="card mb-4">
        ...
        ${Modal({
            ...
            <div class="mb-3">
              ...
              <select class="form-select" id="display_timezone" name="display_timezone">
                ...
                ${availableTimezones.map((tz, i) => html `
        ...
        <div class="table-responsive">
          <table class="table table-sm table-hover table-striped" aria-label="Institutions">
            ...
            <tbody>
              ${institutions.map(({ institution, authn_providers }) => html `
                  <tr>
                    <td>
                      ${isEnterprise()
            ? html `
...
//# sourceMappingURL=administratorInstitutions.html.js.map