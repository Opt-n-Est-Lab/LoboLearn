...
import { AdministratorInstitutions, InstitutionRowSchema, } from './administratorInstitutions.html.js';
...
router.get('/', asyncHandler(async (req, res) => {
    ...
    res.send(AdministratorInstitutions({ institutions, availableTimezones, resLocals: res.locals }));
}));
...
//# sourceMappingURL=administratorInstitutions.js.map