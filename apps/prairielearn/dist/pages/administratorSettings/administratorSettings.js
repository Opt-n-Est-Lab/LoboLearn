...
router.post('/', asyncHandler(async (req, res) => {
    ...
    if (req.body.__action === 'invalidate_question_cache') {
        ...
        try {
            ...
            throw new error.HttpStatusError(400, `could not split course_ids into an array of integers: ${course_ids_string}`);
        }
        ...
        const { benchmarkAiQuestionGeneration } = await import('../../ee/lib/ai-question-generation-benchmark.js');
...
//# sourceMappingURL=administratorSettings.js.map