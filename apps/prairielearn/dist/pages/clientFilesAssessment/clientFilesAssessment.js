...
router.get('/*', asyncHandler(async (req, res) => {
    ...
    const clientFilesDir = path.join(coursePath, 'courseInstances', res.locals.course_instance.short_name, 'assessments', res.locals.assessment.tid, 'clientFilesAssessment');
    res.sendFile(filename, { root: clientFilesDir });
}));
export default router;
//# sourceMappingURL=clientFilesAssessment.js.map