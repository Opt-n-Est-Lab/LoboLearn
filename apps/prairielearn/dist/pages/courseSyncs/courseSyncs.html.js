...
import { IdSchema, JobSequenceSchema, QuestionSchema, UserSchema, } from '../../lib/db-types.js';
...
export function CourseSyncs({ resLocals, images, jobSequences, }) {
      ...
      <div class="card mb-4">
        ...
        <div class="table-responsive">
          <table class="table table-sm table-hover" aria-label="Sync job history">
            ...
            <tbody>
              ${jobSequences.map((jobSequence) => html `
                  <tr>
...
function ImageTable({ images, course, urlPrefix, __csrf_token, }) {
    if (images.length === 0) {
      ...
      <table class="table table-sm" aria-label="Docker images">
        ...
        ? html `
                        ...
                        <button
                          ...
                          data-bs-content="${escapeHtml(ListQuestionsPopover({ image, urlPrefix }))}"
                        >
                          Show
                        </button>
                      `
...
function ListQuestionsPopover({ image, urlPrefix }) {
    return html `
    <div>
      <ul>
        ${image.questions
...
//# sourceMappingURL=courseSyncs.html.js.map