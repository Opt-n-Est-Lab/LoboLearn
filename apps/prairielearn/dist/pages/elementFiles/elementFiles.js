...
export default function (options = { publicQuestionEndpoint: false, coreElements: false }) {
    ...
    router.get('/*', asyncHandler(async (req, res) => {
        ...
        if (options.coreElements) {
            ...
            const has_publicly_shared_question = await sqldb.queryRow(sql.select_has_publicly_shared_question, { course_id: req.params.course_id }, z.boolean());
            ...
            if (req.params.producing_course_id) {
                ...
                const has_shared_question = await sqldb.queryRow(sql.select_has_shared_question, { consuming_course_id: res.locals.course.id, producing_course_id }, z.boolean());
...
//# sourceMappingURL=elementFiles.js.map