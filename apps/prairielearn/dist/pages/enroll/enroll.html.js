...
export function Enroll({ courseInstances, resLocals, }) {
    return PageLayout({
        resLocals,
...
export function EnrollLtiMessage({ ltiInfo, resLocals, }) {
    return html `
    <!doctype html>
    <html lang="en">
      <head>
...
export function EnrollmentLimitExceededMessage({ resLocals }) {
    return PageLayout({
        resLocals,
        pageTitle: 'Enrollment - Courses',
        navContext: {
...
function AddCourseModal({ csrfToken }) {
    return Modal({
        id: 'add-course-modal',
...
function RemoveCourseModal({ csrfToken }) {
    return Modal({
...
//# sourceMappingURL=enroll.html.js.map