...
import { loadSqlEquiv, queryOneRowAsync, queryRow, queryRows, queryZeroOrOneRowAsync, } from '@prairielearn/postgres';
...
import { CourseInstanceRowSchema, Enroll, EnrollLtiMessage, EnrollmentLimitExceededMessage, } from './enroll.html.js';
...
router.get('/', [
    ...
    asyncHandler(async (req, res) => {
        ...
        const courseInstances = await queryRows(sql.select_course_instances, {
...
router.get('/limit_exceeded', asyncHandler((req, res) => {
...
router.post('/', [
    ...
    asyncHandler(async (req, res) => {
        ...
        const { institution, course, course_instance } = await queryRow(sql.select_course_instance, { course_instance_id: req.body.course_instance_id }, z.object({
