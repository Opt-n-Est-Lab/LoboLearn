...
export function ErrorPage({ error, errorInfo, errorId, referrer, resLocals, }) {
    const { outputStderr, outputStdout, sql: sqlQuery, sqlParams, sqlError, ...restData } = error.data ?? {};
...
//# sourceMappingURL=error.html.js.map