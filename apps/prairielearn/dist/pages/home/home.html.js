...
export const InstructorCourseSchema = z.object({
    ...
    course_instances: z.array(z.object({
...
export function Home({ resLocals, instructorCourses, studentCourses, adminInstitutions, }) {
...
function AdminInstitutionsCard({ adminInstitutions }) {
    ...
    <div class="card mb-4">
      ...
      <ul class="list-group list-group-flush">
        ${adminInstitutions.map((institution) => html `
...
function InstructorCoursesCard({ instructorCourses }) {
    ...
    <div class="card mb-4">
      ...
      >
        <tbody>
          ${instructorCourses.map((course) => html `
              <tr>
...
function CourseInstanceList({ course_instances, }) {
    return course_instances.map((course_instance) => html `
      <a
...
function StudentCoursesCard({ studentCourses, hasInstructorCourses, canAddCourses, }) {
      ...
      ${studentCourses.length === 0
        ...
        : html `
            <table class="table table-sm table-hover table-striped" aria-label="${heading}">
              <tbody>
                ${studentCourses.map((courseInstance) => html `
                    <tr>
                      <td>
...
//# sourceMappingURL=home.html.js.map