...
router.get('/', asyncHandler(async (req, res) => {
    ...
    const instructorCourses = await queryRows(sql.select_instructor_courses, {
    ...
    const studentCourses = await queryRows(sql.select_student_courses, {
        user_id: res.locals.authn_user.user_id,
    ...
    const adminInstitutions = await queryRows(sql.select_admin_institutions, { user_id: res.locals.authn_user.user_id }, InstitutionSchema);
