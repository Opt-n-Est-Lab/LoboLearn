...
export function InstructorAssessmentGroups({ groupsCsvFilename, groupConfigInfo, groups, notAssigned, resLocals, }) {
    return PageLayout({
        resLocals,
        pageTitle: 'Groups',
        navContext: {
                    ...
                    ? html `
                                ...
                                <div class="dropdown js-group-action-dropdown">
                                  ...
                                  <div class="dropdown-menu">
                                    <button
                                      ...
                                      data-bs-content="${escapeHtml(AddMembersForm({
                        row,
                        csrfToken: resLocals.__csrf_token,
                    }))}"
                                    >
                        ...
                        ? html `
                                          <button
                                            ...
                                            data-bs-content="${escapeHtml(RemoveMembersForm({
                            row,
                            csrfToken: resLocals.__csrf_token,
                        }))}"
                                          >
                        ...
                        : html `
                                    ...
                                    <button
                                      ...
                                      data-bs-content="${escapeHtml(DeleteGroupForm({
                        row,
                        csrfToken: resLocals.__csrf_token,
                    }))}"
                                    >
...
function AddMembersForm({ row, csrfToken }) {
    return html `
...
function DeleteGroupForm({ row, csrfToken }) {
    return html `
...
function RemoveMembersForm({ row, csrfToken }) {
    return html `
...
function UploadAssessmentGroupsModal({ csrfToken }) {
    return Modal({
...
function RandomAssessmentGroupsModal({ groupMin, groupMax, csrfToken, }) {
    return Modal({
...
function AddGroupModal({ csrfToken }) {
    return Modal({
        id: 'addGroupModal',
        title: 'Add a group',
        body: html `
...
function DeleteAllGroupsModal({ csrfToken, assessmentSetName, assessmentNumber, }) {
    return Modal({
...
//# sourceMappingURL=instructorAssessmentGroups.html.js.map