...
export function InstructorAssessmentInstances({ resLocals }) {
    return PageLayout({
        resLocals,
        pageTitle: 'Instances',
        navContext: {
      ...
      <script src="${nodeModulesAssetPath('bootstrap-table/dist/extensions/auto-refresh/bootstrap-table-auto-refresh.js')}"></script>
      <link
        href="${nodeModulesAssetPath('bootstrap-table/dist/bootstrap-table.min.css')}"
        rel="stylesheet"
      />
      <link
        href="${nodeModulesAssetPath('bootstrap-table/dist/extensions/sticky-header/bootstrap-table-sticky-header.min.css')}"
        rel="stylesheet"
      />
...
function DeleteAssessmentInstanceModal({ assessmentSetName, assessmentNumber, assessmentGroupWork, csrfToken, }) {
    return Modal({
...
function DeleteAllAssessmentInstancesModal({ assessmentSetName, assessmentNumber, csrfToken, }) {
    return Modal({
...
function GradeAllAssessmentInstancesModal({ assessmentSetName, assessmentNumber, csrfToken, }) {
    return Modal({
        id: 'grade-all-form',
...
function CloseAllAssessmentInstancesModal({ assessmentSetName, assessmentNumber, csrfToken, }) {
    return Modal({
...
//# sourceMappingURL=instructorAssessmentInstances.html.js.map