...
import { AutoPointsSection, ManualPointsSection, TotalPointsSection, } from './gradingPointsSection.html.js';
import { RubricInputSection } from './rubricInputSection.html.js';
export function GradingPanel({ resLocals, context, graders, disable, hide_back_to_question, skip_text, custom_points, custom_auto_points, custom_manual_points, grading_job, }) {
    ...
    const open_issues = resLocals.issues.filter((issue) => issue.open);
...
//# sourceMappingURL=gradingPanel.html.js.map