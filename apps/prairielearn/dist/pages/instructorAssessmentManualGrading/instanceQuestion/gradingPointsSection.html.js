...
export function ManualPointsSection({ context, disable, manual_points, resLocals, }) {
    return GradingPointsSection({
        ...
        show_rubric_button: context === 'main' &&
            !resLocals.rubric_data?.replace_auto_points &&
            resLocals.authz_data.has_course_instance_permission_edit,
    });
}
export function AutoPointsSection({ context, disable, auto_points, resLocals, }) {
    return GradingPointsSection({
        context,
        disable,
        type: 'auto',
...
export function TotalPointsSection({ context, disable, points, resLocals, }) {
    return html `
...
export function GradingPointsSection({ type, type_label, context, show_input, points, max_points, show_percentage, disable, show_input_edit, show_rubric_button, }) {
    return html `
    <div class="mb-3">
      <span class="w-100">
        <label
...
//# sourceMappingURL=gradingPointsSection.html.js.map