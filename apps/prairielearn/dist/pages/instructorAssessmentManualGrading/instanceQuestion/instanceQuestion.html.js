...
import { DateFromISOString, GradingJobSchema } from '../../../lib/db-types.js';
...
export function InstanceQuestion({ resLocals, conflict_grading_job, graders, assignedGrader, lastGrader, }) {
    return PageLayout({
        resLocals: {
            ...resLocals,
      ...
      ${resLocals.question.type !== 'Freeform'
            ...
            <script src="${assetPath(`localscripts/question${resLocals.effectiveQuestionType}.js`)}"></script>
          `
            : ''}
...
function ConflictGradingJobModal({ resLocals, conflict_grading_job, graders, lastGrader, }) {
    ...
    DateFromISOString.parse(resLocals.instance_question.modified_at), resLocals.course_instance.display_timezone)},
                  by ${lastGraderName}
                </div>
                <div class="card">
                  ${GradingPanel({
        ...
        : ''}
                ...
                <div class="card">
                  ${GradingPanel({
        resLocals,
        custom_points: (conflict_grading_job.score ?? 0) * resLocals.assessment_question.max_points,
...
//# sourceMappingURL=instanceQuestion.html.js.map