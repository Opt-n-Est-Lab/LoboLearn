...
export function RubricSettingsModal({ resLocals }) {
...
function RubricItemRow({ item, index, }) {
...
function MustachePatterns({ resLocals }) {
    if (!resLocals.variant.params &&
    ...
    <div class="small form-text text-muted">
      ...
      <ul style="max-height: 7rem; overflow-y: auto;">
        ${groups.map(([group, groupName]) => Object.keys(group || {}).map((key) => html `
              <li>
...
//# sourceMappingURL=rubricSettingsModal.html.js.map