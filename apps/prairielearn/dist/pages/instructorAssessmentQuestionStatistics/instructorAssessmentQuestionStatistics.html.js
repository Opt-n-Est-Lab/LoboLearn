...
import { AlternativeGroupSchema, AssessmentQuestionSchema, CourseInstanceSchema, CourseSchema, IdSchema, QuestionSchema, TopicSchema, ZoneSchema, } from '../../lib/db-types.js';
...
export function InstructorAssessmentQuestionStatistics({ questionStatsCsvFilename, statsLastUpdated, rows, resLocals, }) {
              ...
              ${rows.map((row) => html `
                  <tr>
                    ...
                    <td class="text-center align-middle">
                      ${Scorebar(row.mean_question_score ? Math.round(row.mean_question_score) : null)}
                    </td>
                    <td class="text-center align-middle">
      ...
      <div class="card mb-4">
        ...
        <div class="table-responsive">
          ...
          >
            ...
            if (stat !== 'INCREMENTAL_SUBMISSION_SCORE_POINTS_AVERAGES' ||
            ...
            return html `
                ...
                ? html `
                    ...
                    ? html `
                                  <div
                                    class="js-histmini"
                                    data-data="${JSON.stringify(row.incremental_submission_score_array_averages)}"
                                    data-options="${JSON.stringify(histminiOptions)}"
                                  ></div>
                                `
                    : ''}
                    ...
                    ? html `
                        ...
                        ? html `
                                        <div
                                          class="js-histmini"
                                          data-data="${JSON.stringify(row.incremental_submission_points_array_averages)}"
                                          data-options="${JSON.stringify({
                            ...histminiOptions,
                            ymax: row.max_points,
                        })}"
...
//# sourceMappingURL=instructorAssessmentQuestionStatistics.html.js.map