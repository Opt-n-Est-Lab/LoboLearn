...
import { updateAssessmentQuestionStatsForAssessment, updateAssessmentStatistics, } from '../../lib/assessment.js';
import { assessmentFilenamePrefix } from '../../lib/sanitize-name.js';
import { STAT_DESCRIPTIONS } from '../shared/assessmentStatDescriptions.js';
import { AssessmentQuestionStatsRowSchema, InstructorAssessmentQuestionStatistics, } from './instructorAssessmentQuestionStatistics.html.js';
...
router.get('/', asyncHandler(async (req, res) => {
    ...
    // row itself).
    const statsLastUpdated = await sqldb.queryRow(sql.assessment_stats_last_updated, { assessment_id: res.locals.assessment.id }, z.string());
    const rows = await sqldb.queryRows(sql.questions, {
        assessment_id: res.locals.assessment.id,
    }, AssessmentQuestionStatsRowSchema);
    res.send(InstructorAssessmentQuestionStatistics({
...
//# sourceMappingURL=instructorAssessmentQuestionStatistics.js.map