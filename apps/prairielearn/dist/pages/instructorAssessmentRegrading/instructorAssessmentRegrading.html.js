...
export function InstructorAssessmentRegrading({ resLocals, regradingJobSequences, }) {
    return PageLayout({
        resLocals,
        pageTitle: 'Regrading',
        navContext: {
...
function regradeAllAssessmentInstancesModal({ assessmentSetName, assessmentNumber, csrfToken, }) {
    return Modal({
        id: 'regrade-all-form',
...
//# sourceMappingURL=instructorAssessmentRegrading.html.js.map