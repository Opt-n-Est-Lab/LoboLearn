...
export function InstructorAssessmentSettings({ resLocals, origHash, assessmentGHLink, tids, studentLink, publicLink, infoAssessmentPath, assessmentSets, assessmentModules, canEdit, }) {
    return PageLayout({
        resLocals,
        pageTitle: 'Settings',
        navContext: {
          ...
          <form name="edit-assessment-settings-form" method="POST">
            ...
            <div class="mb-3">
              ...
              <select class="form-select" id="module" name="module" ${canEdit ? '' : 'disabled'}>
                ${assessmentModules.map((module) => html `
                    <option
                      value="${module.name}"
...
function AssessmentSharing({ assessment, publicLink, }) {
...
//# sourceMappingURL=instructorAssessmentSettings.html.js.map