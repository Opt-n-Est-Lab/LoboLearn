...
export function InstructorAssessmentStatistics({ resLocals, assessment, durationStat, assessmentScoreHistogramByDate, userScores, filenames, }) {
    return PageLayout({
        resLocals,
            ...
            ? html `
              <div class="card-body">
                <div
                  ...
                  data-histograms="${JSON.stringify(assessmentScoreHistogramByDate.map((day) => ({
...
//# sourceMappingURL=instructorAssessmentStatistics.html.js.map