...
export function InstructorAssessmentUploads({ resLocals, uploadJobSequences, }) {
    return PageLayout({
        resLocals,
        pageTitle: 'Uploads',
        navContext: {
...
function AssessmentUploadCard({ assessmentSetName, assessmentNumber, authzHasPermissionEdit, uploadJobSequences, urlPrefix, }) {
    return html `
    <div class="card mb-4">
...
function UploadInstanceQuestionScoresModal({ csrfToken }) {
    return Modal({
...
function UploadAssessmentInstanceScoresModal({ csrfToken }) {
    return Modal({
...
//# sourceMappingURL=instructorAssessmentUploads.html.js.map