...
router.post('/', asyncHandler(async (req, res) => {
    ...
    if (idsEqual(req.body.course_id, res.locals.course.id)) {
        throw new error.HttpStatusError(400, 'Template course questions cannot be copied to the same course.');
    }
    ...
    const result = await queryRow(sql.select_question, {
...
//# sourceMappingURL=instructorCopyPublicQuestion.js.map