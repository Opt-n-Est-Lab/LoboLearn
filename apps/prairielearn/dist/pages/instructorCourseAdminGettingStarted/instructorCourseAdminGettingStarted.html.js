...
export function InstructorCourseAdminGettingStarted({ tasks, resLocals, }) {
    return PageLayout({
        resLocals,
...
function GettingStartedTask(task) {
    return html `
...
//# sourceMappingURL=instructorCourseAdminGettingStarted.html.js.map