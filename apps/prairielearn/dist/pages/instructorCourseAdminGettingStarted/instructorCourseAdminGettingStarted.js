...
router.get('/', asyncHandler(async (req, res) => {
    res.send(InstructorCourseAdminGettingStarted({
...
router.post('/', asyncHandler(async (req, res) => {
    ...
    flash('success', 'The getting started checklist has been dismissed. You can restore it from your course settings.');
    res.redirect(`${res.locals.urlPrefix}/course_admin/instances`);
}));
export default router;
//# sourceMappingURL=instructorCourseAdminGettingStarted.js.map