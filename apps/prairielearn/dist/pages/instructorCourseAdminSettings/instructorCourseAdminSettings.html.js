...
import { formatTimezone } from '../../lib/timezones.js';
export function InstructorCourseAdminSettings({ resLocals, coursePathExists, courseInfoExists, availableTimezones, origHash, }) {
    return PageLayout({
        resLocals,
      ...
      <div class="card  mb-4">
        ...
        <div class="card-body">
          ...
          <form name="edit-course-settings-form" method="POST">
            ...
            : 'disabled'}
              >
                ${availableTimezones.map((tz) => html `
                    <option
                      value="${tz.name}"
...
function CourseDirectoryMissingAlert({ resLocals, coursePathExists, courseInfoExists, }) {
...
function EditActions({ coursePathExists, courseInfoExists, hasCoursePermissionView, hasCoursePermissionEdit, exampleCourse, urlPrefix, navPage, }) {
...
//# sourceMappingURL=instructorCourseAdminSettings.html.js.map