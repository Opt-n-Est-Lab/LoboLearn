...
function AddCourseToSharingSetPopover({ sharing_set, resLocals, }) {
    return html `
...
export function InstructorCourseAdminSharing({ sharingName, sharingToken, sharingSets, publicSharingLink, canChooseSharingName, resLocals, }) {
    ...
    return PageLayout({
      ...
      <div class="card mb-4">
        ...
        <table class="table table-sm table-hover table-striped" aria-label="Sharing sets">
          ...
          <tbody>
            ${sharingSets.map((sharing_set) => html `
                <tr>
            ...
            ? html `
                          <div class="btn-group btn-group-sm" role="group">
                            <button
                              ...
                              data-bs-content="${escapeHtml(AddCourseToSharingSetPopover({
                resLocals,
                sharing_set,
            }))}"
                            >
...
//# sourceMappingURL=instructorCourseAdminSharing.html.js.map