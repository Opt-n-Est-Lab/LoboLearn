...
import { CourseInstancePermissionSchema, CoursePermissionSchema, UserSchema, } from '../../lib/db-types.js';
...
export function InstructorEffectiveUser({ resLocals, ipAddress, courseRoles, }) {
    ...
    const displayTimezone = resLocals.course_instance?.display_timezone ??
        resLocals.course.display_timezone ??
        resLocals.institution.display_timezone;
    const formattedTrueReqDate = format(toZonedTime(true_req_date, displayTimezone), "yyyy-MM-dd'T'HH:mm:ss.SSSxxx", { timeZone: displayTimezone });
    const formattedReqDate = format(toZonedTime(req_date, displayTimezone), "yyyy-MM-dd'T'HH:mm:ss.SSSxxx", { timeZone: displayTimezone });
    return PageLayout({
            ...
            <form id="changeUidForm" method="POST">
              <div class="mb-3">
                ...
                <datalist id="userList">
                  ${courseRoles.available_uids?.map((available_uid) => html `
      ...
      <div class="card mb-4">
        ...
        <div class="card-body">
          ...
          <div class="alert alert-secondary mb-0">
            ...
            .reverse()
            .map((available_course_role) => available_course_role === authz_data.course_role
            ? html `
      ...
      ${course_instance
            ...
            <div class="card mb-4">
              ...
              <div class="card-body">
                ...
                .reverse()
                .map((available_course_instance_role) => available_course_instance_role === authz_data.course_instance_role
                ? html `
...
//# sourceMappingURL=instructorEffectiveUser.html.js.map