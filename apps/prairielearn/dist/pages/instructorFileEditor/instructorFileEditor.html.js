...
export function InstructorFileEditor({ resLocals, editorData, paths, draftEdit, }) {
            ...
            <div class="row align-items-center justify-content-between">
              <div class="col-auto">
                <span class="font-monospace text-white d-flex">
                  ${joinHtml(paths.branch.map((dir) => dir.canView
            ? html `
                            <a
                              class="text-white"
                          ...
                          `
            : html `<span>${dir.name}</span>`), html `<span class="mx-2">/</span>`)}
                </span>
              </div>
...
//# sourceMappingURL=instructorFileEditor.html.js.map