...
import {} from './instructorGradebook.types.js';
export function InstructorGradebook({ resLocals, courseOwners, csvFilename, courseAssessments, }) {
...
function StudentDataViewMissing({ courseOwners, hasCoursePermissionOwn, urlPrefix, }) {
    return html `
    <div class="card mb-4">
      ...
      <div class="card-body">
        ...
        : courseOwners.length > 0
            ? html `
                ...
                <ul>
                  ${courseOwners.map((owner) => html `<li>${owner.uid} ${owner.name ? `(${owner.name})` : ''}</li>`)}
                </ul>
              `
            : ''}
      </div>
...
//# sourceMappingURL=instructorGradebook.html.js.map