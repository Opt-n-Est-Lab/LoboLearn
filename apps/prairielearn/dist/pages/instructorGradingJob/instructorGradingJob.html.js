...
export function InstructorGradingJob({ resLocals, gradingJobRow, }) {
    const formatGradingJobDate = (date) => date
        ? formatDate(date, resLocals.course_instance?.display_timezone || resLocals.course.display_timezone, { includeMs: true })
        : html `&mdash;`;
    return html `
    <!doctype html>
    <html lang="en">
...
//# sourceMappingURL=instructorGradingJob.html.js.map