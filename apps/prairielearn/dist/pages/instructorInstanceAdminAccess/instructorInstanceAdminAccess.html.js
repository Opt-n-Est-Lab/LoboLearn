...
export function InstructorInstanceAdminAccess({ resLocals, accessRules, }) {
      ...
      <div class="card mb-4">
        ...
        <div class="table-responsive">
          <table class="table table-sm table-hover" aria-label="Access rules">
            ...
            <tbody>
              ${accessRules.map((accessRule) => AccessRuleRow({
            accessRule,
...
function AccessRuleRow({ accessRule, timeZone, hasCourseInstancePermissionView, }) {
    return html `
    <tr>
      <td>
...
//# sourceMappingURL=instructorInstanceAdminAccess.html.js.map