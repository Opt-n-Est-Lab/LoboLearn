...
router.get('/', asyncHandler(async (req, res) => {
    const accessRules = await queryRows(sql.course_instance_access_rules, { course_instance_id: res.locals.course_instance.id }, CourseInstanceAccessRuleSchema);
    res.send(InstructorInstanceAdminAccess({ resLocals: res.locals, accessRules }));
}));
export default router;
//# sourceMappingURL=instructorInstanceAdminAccess.js.map