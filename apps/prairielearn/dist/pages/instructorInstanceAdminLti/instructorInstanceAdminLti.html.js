...
export function InstructorInstanceAdminLti({ resLocals }) {
    const { authz_data, course_owners, lti_credentials, __csrf_token: csrfToken, lti_links, assessments, course_instance: courseInstance, course, urlPrefix, } = resLocals;
    return PageLayout({
        resLocals,
        pageTitle: 'LTI',
        navContext: {
...
function LtiCredentialsCard({ lti_credentials, csrfToken, }) {
    return html `
    <div class="card mb-4">
...
function LtiLinkTargetsCard({ lti_links, assessments, csrfToken, }) {
    return html `
    <div class="card mb-4">
...
//# sourceMappingURL=instructorInstanceAdminLti.html.js.map