...
export function InstructorInstanceAdminSettings({ resLocals, shortNames, studentLink, infoCourseInstancePath, availableTimezones, origHash, canEdit, }) {
    return PageLayout({
        resLocals,
        pageTitle: 'Settings',
        navContext: {
...
function EditConfiguration({ hasCoursePermissionView, hasCoursePermissionEdit, exampleCourse, urlPrefix, navPage, infoCourseInstancePath, }) {
...
function CopyCourseInstanceForm({ csrfToken, shortName, }) {
    return html `
...
//# sourceMappingURL=instructorInstanceAdminSettings.html.js.map