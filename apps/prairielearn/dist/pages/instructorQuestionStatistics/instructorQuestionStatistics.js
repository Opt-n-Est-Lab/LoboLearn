...
import { AssessmentQuestionStatsRowSchema, InstructorQuestionStatistics, } from './instructorQuestionStatistics.html.js';
...
router.get('/', asyncHandler(async (req, res) => {
    ...
    const rows = await sqldb.queryRows(sql.assessment_question_stats, {
        question_id: res.locals.question.id,
    }, AssessmentQuestionStatsRowSchema);
    res.send(InstructorQuestionStatistics({
...
//# sourceMappingURL=instructorQuestionStatistics.js.map