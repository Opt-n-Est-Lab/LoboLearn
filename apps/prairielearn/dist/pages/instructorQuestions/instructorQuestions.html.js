...
export const QuestionsPage = ({ questions, templateQuestions = [], course_instances, showAddQuestionButton, showAiGenerateQuestionButton, resLocals, }) => {
    return PageLayout({
        resLocals,
        pageTitle: 'Questions',
        navContext: {
...
//# sourceMappingURL=instructorQuestions.html.js.map