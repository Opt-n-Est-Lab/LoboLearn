...
export const Lti13CourseRequestInputSchema = z
    ...
    .nullable();
export function RequestCourse({ rows, lti13Info, resLocals, }) {
    return PageLayout({
...
function CourseRequestsCard({ rows }) {
    if (rows.length === 0) {
        return '';
    }
    return html `
...
function CourseNewRequestCard({ csrfToken }) {
    return html `
    <div class="card mb-4">
      <div class="card-header bg-primary text-white d-flex align-items-center">
...
//# sourceMappingURL=instructorRequestCourse.html.js.map