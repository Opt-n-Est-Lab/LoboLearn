...
const router = Router();
router.get('/:job_sequence_id', asyncHandler(async (req, res) => {
    ...
    if (res.locals.authz_data) {
        ...
        if (job_sequence.course_instance_id == null) {
            ...
            if (!res.locals.course_instance) {
                ...
                res.redirect(`${res.locals.plainUrlPrefix}/course_instance/${job_sequence.course_instance_id}/instructor/jobSequence/${job_sequence.id}`);
            }
            if (!res.locals.authz_data.has_course_instance_permission_view) {
                throw new HttpStatusError(403, 'Access denied (must be a Student Data Viewer in the course instance)');
            }
        }
    }
...
//# sourceMappingURL=jobSequence.js.map