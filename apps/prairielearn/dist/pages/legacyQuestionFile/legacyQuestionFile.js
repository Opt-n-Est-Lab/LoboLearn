...
router.get('/:filename', asyncHandler(async (req, res) => {
    ...
    const { effectiveFilename, rootPath } = await filePaths.questionFilePath(filename, question.directory, coursePath, question);
    res.sendFile(effectiveFilename, { root: rootPath });
}));
export default router;
//# sourceMappingURL=legacyQuestionFile.js.map