...
router.get('/:filename', asyncHandler(async (req, res) => {
    ...
    const { rootPath, effectiveFilename } = await filePaths.questionFilePath(filename, question.directory, coursePath, question);
    res.sendFile(effectiveFilename, { root: rootPath });
}));
export default router;
//# sourceMappingURL=legacyQuestionText.js.map