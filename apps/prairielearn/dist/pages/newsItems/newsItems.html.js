...
export function NewsItems({ resLocals, newsItems, userIsInstructor, }) {
    const { urlPrefix, news_item_notification_count: newsItemNotificationCount } = resLocals;
    return PageLayout({
        resLocals,
        pageTitle: 'News',
        navContext: {
        ...
        options: {
            pageNote: (newsItemNotificationCount ?? 0 > 0) ? `${newsItemNotificationCount} Unread` : undefined,
        },
        content: html `
      <div class="card mb-4">
...
//# sourceMappingURL=newsItems.html.js.map