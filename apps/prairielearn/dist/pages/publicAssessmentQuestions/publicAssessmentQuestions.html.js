...
import {} from '../../models/assessment-question.js';
export function PublicAssessmentQuestions({ resLocals, assessment, assessment_set, course, course_instance_id, questions, }) {
    return PageLayout({
        resLocals,
        pageTitle: 'Questions',
        navContext: {
...
function AssessmentQuestionsTable({ questions, urlPrefix, course_id, course_instance_id, }) {
    const nTableCols = 4;
    return html `
...
//# sourceMappingURL=publicAssessmentQuestions.html.js.map