...
async function setLocals(req, res) {
    ...
    if (!res.locals.question.share_source_publicly ||
...
router.get('/*', asyncHandler(async (req, res) => {
    ...
    if (req.query.type)
        res.type(req.query.type.toString());
    if (req.query.attachment)
        res.attachment(req.query.attachment.toString());
    res.sendFile(req.params[0], { root: res.locals.course.path });
}));
export default router;
//# sourceMappingURL=publicQuestionFileDownload.js.map