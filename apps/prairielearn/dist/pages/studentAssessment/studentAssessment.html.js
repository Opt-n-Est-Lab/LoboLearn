...
import {} from '../../lib/groups.js';
export function StudentAssessment({ resLocals, groupConfig, groupInfo, userCanAssignRoles, }) {
...
function StartAssessmentForm({ assessment, user, __csrf_token, startAllowed, }) {
    return html `
...
function HonorPledge({ user, groupWork }) {
    return html `
...
function StudentGroupControls({ groupConfig, groupInfo, userCanAssignRoles = false, resLocals, }) {
    if (groupConfig == null)
        return '';
...
function GroupCreationJoinForm({ groupConfig, __csrf_token, }) {
...
//# sourceMappingURL=studentAssessment.html.js.map