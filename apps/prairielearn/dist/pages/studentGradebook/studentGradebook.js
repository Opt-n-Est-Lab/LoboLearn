...
router.get('/', asyncHandler(async (req, res) => {
    const rows = await queryRows(sql.select_assessment_instances, {
        course_instance_id: res.locals.course_instance.id,
        user_id: res.locals.user.user_id,
        authz_data: res.locals.authz_data,
        req_date: res.locals.req_date,
    }, StudentGradebookRowSchema);
    res.send(StudentGradebook({
...
router.get('/:filename', asyncHandler(async (req, res) => {
    ...
    const cursor = await queryValidatedCursor(sql.select_assessment_instances, {
        course_instance_id: res.locals.course_instance.id,
        user_id: res.locals.user.user_id,
        authz_data: res.locals.authz_data,
        req_date: res.locals.req_date,
...
//# sourceMappingURL=studentGradebook.js.map