...
export function StudentInstanceQuestion({ resLocals, userCanDeleteAssessmentInstance, assignedGrader, lastGrader, }) {
    const questionContext = resLocals.assessment.type === 'Exam' ? 'student_exam' : 'student_homework';
    return html `
    <!doctype html>
    <html lang="en">
      <head>
      ...
      <body>
        ...
        sequenceLocked: resLocals.instance_question_info.next_instance_question?.sequence_locked,
...
//# sourceMappingURL=studentInstanceQuestion.html.js.map