...
export default function (options = { publicEndpoint: false }) {
    ...
    router.get('/*', asyncHandler(async (req, res) => {
        ...
        const unsafe_variant_id = await sqldb.queryOptionalRow(sql.select_variant_id_by_submission_id, {
        ...
        const contents = await sqldb.queryOptionalRow(sql.select_submission_file, {
...
//# sourceMappingURL=submissionFile.js.map