...
export function Workspace({ pageTitle, pageNote, navTitle, navTitleHref, showLogs, heartbeatIntervalSec, visibilityTimeoutSec, socketToken, resLocals, }) {
...
function ResetModal({ __csrf_token }) {
    return Modal({
        id: 'resetModal',
...
function RebootModal({ __csrf_token }) {
    return Modal({
        id: 'rebootModal',
...
//# sourceMappingURL=workspace.html.js.map