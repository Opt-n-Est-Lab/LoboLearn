...
export function WorkspaceLogs({ workspaceLogs, resLocals, }) {
...
export function WorkspaceVersionLogs({ workspaceLogs, containerLogs, containerLogsEnabled, containerLogsExpired, resLocals, }) {
    return html `
    <!doctype html>
    <html lang="en">
      <head>
...
export function WorkspaceLogsTable({ workspaceLogs, includeVersion = true, }) {
    return html `
    <div class="table-responsive">
...
//# sourceMappingURL=workspaceLogs.html.js.map