...
const DependencyJsonSchema = z
    ...
    coreStyles: z
        ...
        .describe('[DEPRECATED, DO NOT USE] The styles required by this element from /public/stylesheets.')
        .optional(),
    coreScripts: z
        .array(z.string().describe('A .js file located in /public/javascripts.'))
        .describe('[DEPRECATED, DO NOT USE] The scripts required by this element from /public/javascripts.')
        .optional(),
    nodeModulesStyles: z
...
const DynamicDependencyJsonSchema = z
    ...
    elementScripts: z
        .record(z.string())
        .describe("The scripts required by this element from the element's directory as an importmap.")
        .optional(),
})
    .strict()
...
//# sourceMappingURL=infoElementCourse.js.map