...
const DependencyJsonSchema = z
    ...
    coreStyles: z
        ...
        .describe('[DEPRECATED, DO NOT USE] The styles required by this extension from /public/stylesheets.')
        .optional(),
    coreScripts: z
        .array(z.string().describe('A .js file located in /public/javascripts.'))
        .describe('[DEPRECATED, DO NOT USE] The scripts required by this extension from /public/javascripts.')
        .optional(),
    nodeModulesStyles: z
...
//# sourceMappingURL=infoElementExtension.js.map