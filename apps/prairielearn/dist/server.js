...
import { SCHEMA_MIGRATIONS_PATH, initBatchedMigrations, startBatchedMigrations, stopBatchedMigrations, } from '@prairielearn/migrations';
...
export async function initExpress() {
    ...
    app.post('/pl/course_instance/:course_instance_id(\\d+)/instructor/assessment/:assessment_id(\\d+)/uploads', upload.single('file'));
    app.post('/pl/course_instance/:course_instance_id(\\d+)/instance_question/:instance_question_id(\\d+)', upload.single('file'));
    app.post('/pl/course_instance/:course_instance_id(\\d+)/assessment_instance/:assessment_instance_id(\\d+)', upload.single('file'));
    app.post('/pl/course_instance/:course_instance_id(\\d+)/instructor/question/:question_id(\\d+)', upload.single('file'));
    app.post('/pl/course/:course_id(\\d+)/question/:question_id(\\d+)', upload.single('file'));
    app.post('/pl/course/:course_id(\\d+)/question/:question_id(\\d+)/file_view', upload.single('file'));
    app.post('/pl/course/:course_id(\\d+)/question/:question_id(\\d+)/file_view/*', upload.single('file'));
    app.post('/pl/course_instance/:course_instance_id(\\d+)/instructor/assessment/:assessment_id(\\d+)/settings', upload.single('file'));
    app.post('/pl/course_instance/:course_instance_id(\\d+)/instructor/instance_admin/settings', upload.single('file'));
    app.post('/pl/course_instance/:course_instance_id(\\d+)/instructor/course_admin/settings', upload.single('file'));
    ...
    app.post('/pl/course/:course_id(\\d+)/course_admin/file_view/*', upload.single('file'));
    app.post('/pl/course_instance/:course_instance_id(\\d+)/instructor/course_admin/file_view', upload.single('file'));
    app.post('/pl/course_instance/:course_instance_id(\\d+)/instructor/course_admin/file_view/*', upload.single('file'));
    app.post('/pl/course_instance/:course_instance_id(\\d+)/instructor/instance_admin/file_view', upload.single('file'));
    app.post('/pl/course_instance/:course_instance_id(\\d+)/instructor/instance_admin/file_view/*', upload.single('file'));
    app.post('/pl/course_instance/:course_instance_id(\\d+)/instructor/assessment/:assessment_id(\\d+)/file_view', upload.single('file'));
    app.post('/pl/course_instance/:course_instance_id(\\d+)/instructor/assessment/:assessment_id(\\d+)/file_view/*', upload.single('file'));
    app.post('/pl/course_instance/:course_instance_id(\\d+)/instructor/question/:question_id(\\d+)/file_view', upload.single('file'));
    app.post('/pl/course_instance/:course_instance_id(\\d+)/instructor/question/:question_id(\\d+)/file_view/*', upload.single('file'));
    app.post('/pl/course_instance/:course_instance_id(\\d+)/instructor/assessment/:assessment_id(\\d+)/groups', upload.single('file'));
    ...
    app.use((req, res, next) => {
        ...
        if (req.path === '/pl/webhooks/stripe')
            return next();
    ...
    if (config.devMode)
        app.use(favicon(path.join(APP_ROOT_PATH, 'public', 'favicon-dev.ico')));
    else
        app.use(favicon(path.join(APP_ROOT_PATH, 'public', 'favicon.ico')));
    ...
    app.use('/localscripts/calculationQuestion/ace', staticNodeModules(path.join('ace-builds', 'src-min-noconflict')));
    ...
    app.use('/pl/oauth2callback', (await import('./pages/authCallbackOAuth2/authCallbackOAuth2.js')).default);
    app.use(/\/pl\/shibcallback/, (await import('./pages/authCallbackShib/authCallbackShib.js')).default);
    if (isEnterprise()) {
        if (config.hasAzure) {
        ...
        app.use('/pl/auth/institution/:institution_id(\\d+)/saml', (await import('./ee/auth/saml/router.js')).default);
    }
    ...
    app.use('/pl/webhooks/stripe', await enterpriseOnly(async () => (await import('./ee/webhooks/stripe/index.js')).default));
    ...
    app.use('/pl/navbar/course/:course_id(\\d+)/switcher', (await import('./pages/navbarCourseSwitcher/navbarCourseSwitcher.js')).default);
    app.use('/pl/navbar/course/:course_id(\\d+)/course_instance_switcher/:course_instance_id(\\d+)?', [
    ...
    app.use('/pl/workspace/:workspace_id(\\d+)', (await import('./pages/workspace/workspace.js')).default);
    app.use('/pl/workspace/:workspace_id(\\d+)/logs', (await import('./pages/workspaceLogs/workspaceLogs.js')).default);
    // dev-mode pages are mounted for both out-of-course access (here) and within-course access (see below)
    if (config.devMode) {
        app.use('/pl/loadFromDisk', (await import('./pages/instructorLoadFromDisk/instructorLoadFromDisk.js')).default);
    ...
    app.use('/pl/course_instance/:course_instance_id(\\d+)', (await import('./middlewares/authzCourseOrInstance.js')).default);
    ...
    app.use('/pl/course_instance/:course_instance_id(\\d+)/news_items', (await import('./pages/newsItems/newsItems.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/news_item', (await import('./pages/newsItem/newsItem.js')).default);
    ...
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/effectiveUser', (await import('./pages/instructorEffectiveUser/instructorEffectiveUser.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/news_items', (await import('./pages/newsItems/newsItems.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/news_item', (await import('./pages/newsItem/newsItem.js')).default);
    // All other course instance student pages require the effective user to have permissions
    app.use('/pl/course_instance/:course_instance_id(\\d+)', (await import('./middlewares/authzHasCourseInstanceAccess.js')).default);
    // All other course instance instructor pages require the effective user to have permissions
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor', (await import('./middlewares/authzHasCoursePreviewOrInstanceView.js')).default);
    ...
    app.use('/pl/course_instance/:course_instance_id(\\d+)/sharedElements/course/:producing_course_id(\\d+)/cacheableElements/:cachebuster', (await import('./pages/elementFiles/elementFiles.js')).default());
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/sharedElements/course/:producing_course_id(\\d+)/cacheableElements/:cachebuster', (await import('./pages/elementFiles/elementFiles.js')).default());
    app.use('/pl/course/:course_id(\\d+)/sharedElements/course/:producing_course_id(\\d+)/cacheableElements/:cachebuster', (await import('./pages/elementFiles/elementFiles.js')).default());
    app.use('/pl/course_instance/:course_instance_id(\\d+)/cacheableElements/:cachebuster', (await import('./pages/elementFiles/elementFiles.js')).default());
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/cacheableElements/:cachebuster', (await import('./pages/elementFiles/elementFiles.js')).default());
    app.use('/pl/course/:course_id(\\d+)/cacheableElements/:cachebuster', (await import('./pages/elementFiles/elementFiles.js')).default());
    app.use('/pl/course_instance/:course_instance_id(\\d+)/cacheableElementExtensions/:cachebuster', (await import('./pages/elementExtensionFiles/elementExtensionFiles.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/cacheableElementExtensions/:cachebuster', (await import('./pages/elementExtensionFiles/elementExtensionFiles.js')).default);
    app.use('/pl/course/:course_id(\\d+)/cacheableElementExtensions/:cachebuster', (await import('./pages/elementExtensionFiles/elementExtensionFiles.js')).default);
    ...
    app.use('/pl/course_instance/:course_instance_id(\\d+)/elements', (await import('./pages/elementFiles/elementFiles.js')).default());
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/elements', (await import('./pages/elementFiles/elementFiles.js')).default());
    app.use('/pl/course/:course_id(\\d+)/elements', (await import('./pages/elementFiles/elementFiles.js')).default());
    app.use('/pl/course_instance/:course_instance_id(\\d+)/sharedElements/course/:producing_course_id(\\d+)/elements', (await import('./pages/elementFiles/elementFiles.js')).default());
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/sharedElements/course/:producing_course_id(\\d+)/elements', (await import('./pages/elementFiles/elementFiles.js')).default());
    app.use('/pl/course/:course_id(\\d+)/sharedElements/course/:producing_course_id(\\d+)/elements', (await import('./pages/elementFiles/elementFiles.js')).default());
    app.use('/pl/course_instance/:course_instance_id(\\d+)/elementExtensions', (await import('./pages/elementExtensionFiles/elementExtensionFiles.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/elementExtensions', (await import('./pages/elementExtensionFiles/elementExtensionFiles.js')).default);
    app.use('/pl/course/:course_id(\\d+)/elementExtensions', (await import('./pages/elementExtensionFiles/elementExtensionFiles.js')).default);
    //////////////////////////////////////////////////////////////////////
    //////////////////////////////////////////////////////////////////////
    //////////////////////////////////////////////////////////////////////
    // API ///////////////////////////////////////////////////////////////
    ...
    // Instructor pages //////////////////////////////////////////////////
    // single assessment
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/assessment/:assessment_id(\\d+)', [
    ...
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/assessment/:assessment_id(\\d+)', function (req, res, next) {
        res.locals.navPage = 'assessment';
        next();
    });
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/assessment/:assessment_id(\\d+)/settings', [
        function (req, res, next) {
    ...
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/assessment/:assessment_id(\\d+)/questions', [
        function (req, res, next) {
    ...
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/assessment/:assessment_id(\\d+)/groups', [
        function (req, res, next) {
    ...
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/assessment/:assessment_id(\\d+)/access', [
        function (req, res, next) {
    ...
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/assessment/:assessment_id(\\d+)/assessment_statistics', [
        function (req, res, next) {
    ...
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/assessment/:assessment_id(\\d+)/question_statistics', [
        function (req, res, next) {
            res.locals.navSubPage = 'question_statistics';
            next();
        },
        (await import('./pages/instructorAssessmentQuestionStatistics/instructorAssessmentQuestionStatistics.js')).default,
    ]);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/assessment/:assessment_id(\\d+)/downloads', [
        function (req, res, next) {
    ...
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/assessment/:assessment_id(\\d+)/uploads', [
        function (req, res, next) {
    ...
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/assessment/:assessment_id(\\d+)/regrading', [
        function (req, res, next) {
    ...
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/assessment/:assessment_id(\\d+)/instances', [
        function (req, res, next) {
    ...
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/assessment/:assessment_id(\\d+)/file_edit', (await import('./pages/instructorFileEditor/instructorFileEditor.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/assessment/:assessment_id(\\d+)/file_view', (await import('./pages/instructorFileBrowser/instructorFileBrowser.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/assessment/:assessment_id(\\d+)/file_download', (await import('./pages/instructorFileDownload/instructorFileDownload.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/assessment/:assessment_id(\\d+)/manual_grading/assessment_question/:assessment_question_id(\\d+)', [
        function (req, res, next) {
            res.locals.navSubPage = 'manual_grading';
            next();
        },
        (await import('./middlewares/selectAndAuthzAssessmentQuestion.js')).default,
        (await import('./pages/instructorAssessmentManualGrading/assessmentQuestion/assessmentQuestion.js')).default,
    ]);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/assessment/:assessment_id(\\d+)/manual_grading/assessment_question/:assessment_question_id(\\d+)/ai_grading_runs', (await import('./ee/pages/instructorAiGradingRuns/instructorAiGradingRuns.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/assessment/:assessment_id(\\d+)/manual_grading/instance_question/:instance_question_id(\\d+)', [
        function (req, res, next) {
            res.locals.navSubPage = 'manual_grading';
            next();
        },
        (await import('./middlewares/selectAndAuthzInstanceQuestion.js')).default,
        (await import('./pages/instructorAssessmentManualGrading/instanceQuestion/instanceQuestion.js')).default,
    ]);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/instance_question/:instance_question_id(\\d+)/clientFilesCourse', (await import('./pages/clientFilesCourse/clientFilesCourse.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/instance_question/:instance_question_id(\\d+)/clientFilesQuestion', [
        (await import('./middlewares/selectAndAuthzInstanceQuestion.js')).default,
        (await import('./pages/clientFilesQuestion/clientFilesQuestion.js')).default(),
    ]);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/instance_question/:instance_question_id(\\d+)/generatedFilesQuestion', [
        (await import('./middlewares/selectAndAuthzInstanceQuestion.js')).default,
        (await import('./pages/generatedFilesQuestion/generatedFilesQuestion.js')).default(),
    ]);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/instance_question/:instance_question_id(\\d+)/file', [
        (await import('./middlewares/selectAndAuthzInstanceQuestion.js')).default,
        (await import('./pages/legacyQuestionFile/legacyQuestionFile.js')).default,
    ]);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/instance_question/:instance_question_id(\\d+)/text', [
        (await import('./middlewares/selectAndAuthzInstanceQuestion.js')).default,
        (await import('./pages/legacyQuestionText/legacyQuestionText.js')).default,
    ]);
    // Submission files
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/instance_question/:instance_question_id(\\d+)/submission/:unsafe_submission_id(\\d+)/file', [
        (await import('./middlewares/selectAndAuthzInstanceQuestion.js')).default,
        (await import('./pages/submissionFile/submissionFile.js')).default(),
    ]);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/assessment/:assessment_id(\\d+)/manual_grading', [
        function (req, res, next) {
            res.locals.navSubPage = 'manual_grading';
            next();
        },
    ...
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/assessment_instance/:assessment_instance_id(\\d+)', [
    ...
    // single question
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/question/:question_id(\\d+)', (await import('./middlewares/selectAndAuthzInstructorQuestion.js')).default, (await import('./middlewares/authzHasCoursePreview.js')).default);
    ...
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/question/:question_id(\\d+)', function (req, res, next) {
        res.locals.navPage = 'question';
        next();
    });
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/question/:question_id(\\d+)/settings', (await import('./pages/instructorQuestionSettings/instructorQuestionSettings.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/question/:question_id(\\d+)/preview', (await import('./pages/instructorQuestionPreview/instructorQuestionPreview.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/question/:question_id(\\d+)/statistics', [
        function (req, res, next) {
    ...
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/question/:question_id(\\d+)/file_edit', (await import('./pages/instructorFileEditor/instructorFileEditor.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/question/:question_id(\\d+)/file_view', (await import('./pages/instructorFileBrowser/instructorFileBrowser.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/question/:question_id(\\d+)/file_download', (await import('./pages/instructorFileDownload/instructorFileDownload.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/grading_job', (await import('./pages/instructorGradingJob/instructorGradingJob.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/jobSequence', (await import('./pages/jobSequence/jobSequence.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/loadFromDisk', (await import('./pages/instructorLoadFromDisk/instructorLoadFromDisk.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/edit_error', (await import('./pages/editError/editError.js')).default);
    ...
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/course_admin', function (req, res, next) {
        res.locals.navPage = 'course_admin';
        next();
    });
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/course_admin/settings', (await import('./pages/instructorCourseAdminSettings/instructorCourseAdminSettings.js'))
        .default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/course_admin/sharing', (await import('./pages/instructorCourseAdminSharing/instructorCourseAdminSharing.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/course_admin/staff', (await import('./pages/instructorCourseAdminStaff/instructorCourseAdminStaff.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/course_admin/sets', (await import('./pages/instructorCourseAdminSets/instructorCourseAdminSets.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/course_admin/modules', (await import('./pages/instructorCourseAdminModules/instructorCourseAdminModules.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/course_admin/instances', (await import('./pages/instructorCourseAdminInstances/instructorCourseAdminInstances.js'))
        .default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/course_admin/issues', (await import('./pages/instructorIssues/instructorIssues.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/course_admin/questions', (await import('./pages/instructorQuestions/instructorQuestions.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/course_admin/getting_started', (await import('./pages/instructorCourseAdminGettingStarted/instructorCourseAdminGettingStarted.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/ai_generate_editor/:question_id(\\d+)', (await import('./ee/pages/instructorAiGenerateDraftEditor/instructorAiGenerateDraftEditor.js'))
        .default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/ai_generate_question_drafts', (await import('./ee/pages/instructorAiGenerateDrafts/instructorAiGenerateDrafts.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/course_admin/syncs', (await import('./pages/courseSyncs/courseSyncs.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/course_admin/topics', (await import('./pages/instructorCourseAdminTopics/instructorCourseAdminTopics.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/course_admin/tags', (await import('./pages/instructorCourseAdminTags/instructorCourseAdminTags.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/course_admin/file_edit', (await import('./pages/instructorFileEditor/instructorFileEditor.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/course_admin/file_view', (await import('./pages/instructorFileBrowser/instructorFileBrowser.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/course_admin/file_download', (await import('./pages/instructorFileDownload/instructorFileDownload.js')).default);
    // course instance - instance admin pages
    app.use(/^(\/pl\/course_instance\/[0-9]+\/instructor\/instance_admin)\/?$/, (req, res, _next) => {
        res.redirect(`${req.params[0]}/assessments`);
    });
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/instance_admin', function (req, res, next) {
        ...
        const hasCourseInstanceBilling = await features.enabledFromLocals('course-instance-billing', res.locals);
    ...
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/instance_admin/settings', (await import('./pages/instructorInstanceAdminSettings/instructorInstanceAdminSettings.js'))
        .default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/instance_admin/access', (await import('./pages/instructorInstanceAdminAccess/instructorInstanceAdminAccess.js'))
        .default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/instance_admin/assessments', (await import('./pages/instructorAssessments/instructorAssessments.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/instance_admin/gradebook', (await import('./pages/instructorGradebook/instructorGradebook.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/instance_admin/lti', (await import('./pages/instructorInstanceAdminLti/instructorInstanceAdminLti.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/instance_admin/file_edit', (await import('./pages/instructorFileEditor/instructorFileEditor.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/instance_admin/file_view', (await import('./pages/instructorFileBrowser/instructorFileBrowser.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/instance_admin/file_download', (await import('./pages/instructorFileDownload/instructorFileDownload.js')).default);
    if (isEnterprise()) {
        app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/instance_admin/billing', (await import('./ee/pages/instructorInstanceAdminBilling/instructorInstanceAdminBilling.js'))
            .default);
        app.use('/pl/course_instance/:course_instance_id/instructor/instance_admin/lti13_instance', (await import('./ee/pages/instructorInstanceAdminLti13/instructorInstanceAdminLti13.js'))
            .default);
    }
    // Global client files
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/clientFilesCourse', (await import('./pages/clientFilesCourse/clientFilesCourse.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/clientFilesCourseInstance', (await import('./pages/clientFilesCourseInstance/clientFilesCourseInstance.js')).default);
    // Client files for assessments
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/assessment/:assessment_id(\\d+)/clientFilesCourse', (await import('./pages/clientFilesCourse/clientFilesCourse.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/assessment/:assessment_id(\\d+)/clientFilesCourseInstance', (await import('./pages/clientFilesCourseInstance/clientFilesCourseInstance.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/assessment/:assessment_id(\\d+)/clientFilesAssessment', [
        (await import('./middlewares/selectAndAuthzAssessment.js')).default,
        (await import('./pages/clientFilesAssessment/clientFilesAssessment.js')).default,
    ]);
    // Client files for questions
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/question/:question_id(\\d+)/clientFilesCourse', (await import('./pages/clientFilesCourse/clientFilesCourse.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/question/:question_id(\\d+)/clientFilesQuestion', [
        (await import('./middlewares/selectAndAuthzInstructorQuestion.js')).default,
        (await import('./pages/clientFilesQuestion/clientFilesQuestion.js')).default(),
    ]);
    // generatedFiles
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/question/:question_id(\\d+)/generatedFilesQuestion', [
        (await import('./middlewares/selectAndAuthzInstructorQuestion.js')).default,
        (await import('./pages/generatedFilesQuestion/generatedFilesQuestion.js')).default(),
    ]);
    // Submission files
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/question/:question_id(\\d+)/submission/:unsafe_submission_id(\\d+)/file', [
        (await import('./middlewares/selectAndAuthzInstructorQuestion.js')).default,
        (await import('./pages/submissionFile/submissionFile.js')).default(),
    ]);
    // legacy client file paths
    // handle routes with and without /preview/ in them to handle URLs with and without trailing slashes
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/question/:question_id(\\d+)/file', [
        (await import('./middlewares/selectAndAuthzInstructorQuestion.js')).default,
        (await import('./pages/legacyQuestionFile/legacyQuestionFile.js')).default,
    ]);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/question/:question_id(\\d+)/preview/file', [
        (await import('./middlewares/selectAndAuthzInstructorQuestion.js')).default,
        (await import('./pages/legacyQuestionFile/legacyQuestionFile.js')).default,
    ]);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/question/:question_id(\\d+)/text', [
        (await import('./middlewares/selectAndAuthzInstructorQuestion.js')).default,
        (await import('./pages/legacyQuestionText/legacyQuestionText.js')).default,
    ]);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instructor/question/:question_id(\\d+)/preview/text', [
        (await import('./middlewares/selectAndAuthzInstructorQuestion.js')).default,
        (await import('./pages/legacyQuestionText/legacyQuestionText.js')).default,
    ]);
    //////////////////////////////////////////////////////////////////////
    ...
    app.use('/pl/course_instance/:course_instance_id(\\d+)/assessments', (await import('./pages/studentAssessments/studentAssessments.js')).default);
    ...
    app.use('/pl/course_instance/:course_instance_id(\\d+)/assessment/:assessment_id(\\d+)/clientFilesCourse', [
        (await import('./middlewares/selectAndAuthzAssessment.js')).default,
    ...
    app.use('/pl/course_instance/:course_instance_id(\\d+)/assessment/:assessment_id(\\d+)/clientFilesCourseInstance', [
        (await import('./middlewares/selectAndAuthzAssessment.js')).default,
        (await import('./middlewares/studentAssessmentAccess.js')).default,
        (await import('./pages/clientFilesCourseInstance/clientFilesCourseInstance.js')).default,
    ]);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/assessment/:assessment_id(\\d+)/clientFilesAssessment', [
        (await import('./middlewares/selectAndAuthzAssessment.js')).default,
        (await import('./middlewares/studentAssessmentAccess.js')).default,
        (await import('./pages/clientFilesAssessment/clientFilesAssessment.js')).default,
    ]);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/assessment/:assessment_id(\\d+)', (await import('./pages/studentAssessment/studentAssessment.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/assessment_instance/:assessment_instance_id(\\d+)/file', (await import('./pages/studentAssessmentInstanceFile/studentAssessmentInstanceFile.js'))
        .default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/assessment_instance/:assessment_instance_id(\\d+)/time_remaining', (await import('./pages/studentAssessmentInstanceTimeRemaining/studentAssessmentInstanceTimeRemaining.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/assessment_instance/:assessment_instance_id(\\d+)', (await import('./pages/studentAssessmentInstance/studentAssessmentInstance.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instance_question/:instance_question_id(\\d+)', (await import('./pages/studentInstanceQuestion/studentInstanceQuestion.js')).default);
    if (config.devMode) {
        app.use('/pl/course_instance/:course_instance_id(\\d+)/loadFromDisk', (await import('./pages/instructorLoadFromDisk/instructorLoadFromDisk.js')).default);
        app.use('/pl/course_instance/:course_instance_id(\\d+)/jobSequence', (await import('./pages/jobSequence/jobSequence.js')).default);
    }
    // Global client files
    app.use('/pl/course_instance/:course_instance_id(\\d+)/clientFilesCourse', (await import('./pages/clientFilesCourse/clientFilesCourse.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/clientFilesCourseInstance', (await import('./pages/clientFilesCourseInstance/clientFilesCourseInstance.js')).default);
    // Client files for questions
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instance_question/:instance_question_id(\\d+)/clientFilesCourse', (await import('./pages/clientFilesCourse/clientFilesCourse.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instance_question/:instance_question_id(\\d+)/clientFilesQuestion', (await import('./pages/clientFilesQuestion/clientFilesQuestion.js')).default());
    // generatedFiles
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instance_question/:instance_question_id(\\d+)/generatedFilesQuestion', (await import('./pages/generatedFilesQuestion/generatedFilesQuestion.js')).default());
    // Submission files
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instance_question/:instance_question_id(\\d+)/submission/:unsafe_submission_id(\\d+)/file', (await import('./pages/submissionFile/submissionFile.js')).default());
    // legacy client file paths
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instance_question/:instance_question_id(\\d+)/file', (await import('./pages/legacyQuestionFile/legacyQuestionFile.js')).default);
    app.use('/pl/course_instance/:course_instance_id(\\d+)/instance_question/:instance_question_id(\\d+)/text', (await import('./pages/legacyQuestionText/legacyQuestionText.js')).default);
    //////////////////////////////////////////////////////////////////////
    //////////////////////////////////////////////////////////////////////
    //////////////////////////////////////////////////////////////////////
    // Course pages //////////////////////////////////////////////////////
    ...
    app.use('/pl/course/:course_id(\\d+)/effectiveUser', (await import('./pages/instructorEffectiveUser/instructorEffectiveUser.js')).default);
    app.use('/pl/course/:course_id(\\d+)/news_items', (await import('./pages/newsItems/newsItems.js')).default);
    app.use('/pl/course/:course_id(\\d+)/news_item', (await import('./pages/newsItem/newsItem.js')).default);
    // All other course pages require the effective user to have permission
    app.use('/pl/course/:course_id(\\d+)', (await import('./middlewares/authzHasCoursePreview.js')).default);
    // single question
    app.use('/pl/course/:course_id(\\d+)/question/:question_id(\\d+)', (await import('./middlewares/selectAndAuthzInstructorQuestion.js')).default);
    ...
    app.use('/pl/course/:course_id(\\d+)/question/:question_id(\\d+)/settings', (await import('./pages/instructorQuestionSettings/instructorQuestionSettings.js')).default);
    app.use('/pl/course/:course_id(\\d+)/question/:question_id(\\d+)/preview', (await import('./pages/instructorQuestionPreview/instructorQuestionPreview.js')).default);
    app.use('/pl/course/:course_id(\\d+)/question/:question_id(\\d+)/statistics', (await import('./pages/instructorQuestionStatistics/instructorQuestionStatistics.js')).default);
    app.use('/pl/course/:course_id(\\d+)/question/:question_id(\\d+)/file_edit', (await import('./pages/instructorFileEditor/instructorFileEditor.js')).default);
    app.use('/pl/course/:course_id(\\d+)/question/:question_id(\\d+)/file_view', (await import('./pages/instructorFileBrowser/instructorFileBrowser.js')).default);
    app.use('/pl/course/:course_id(\\d+)/question/:question_id(\\d+)/file_download', (await import('./pages/instructorFileDownload/instructorFileDownload.js')).default);
    app.use('/pl/course/:course_id(\\d+)/file_transfer', [
        (await import('./pages/instructorFileTransfer/instructorFileTransfer.js')).default,
    ]);
    app.use('/pl/course/:course_id(\\d+)/edit_error', (await import('./pages/editError/editError.js')).default);
    app.use('/pl/course/:course_id(\\d+)/course_admin', (await import('./pages/instructorCourseAdmin/instructorCourseAdmin.js')).default);
    app.use('/pl/course/:course_id(\\d+)/course_admin', function (req, res, next) {
        res.locals.navPage = 'course_admin';
        next();
    });
    app.use('/pl/course/:course_id(\\d+)/course_admin/settings', (await import('./pages/instructorCourseAdminSettings/instructorCourseAdminSettings.js'))
        .default);
    app.use('/pl/course/:course_id(\\d+)/course_admin/sharing', (await import('./pages/instructorCourseAdminSharing/instructorCourseAdminSharing.js')).default);
    app.use('/pl/course/:course_id(\\d+)/course_admin/staff', (await import('./pages/instructorCourseAdminStaff/instructorCourseAdminStaff.js')).default);
    app.use('/pl/course/:course_id(\\d+)/course_admin/sets', (await import('./pages/instructorCourseAdminSets/instructorCourseAdminSets.js')).default);
    app.use('/pl/course/:course_id(\\d+)/course_admin/modules', (await import('./pages/instructorCourseAdminModules/instructorCourseAdminModules.js')).default);
    app.use('/pl/course/:course_id(\\d+)/course_admin/instances', (await import('./pages/instructorCourseAdminInstances/instructorCourseAdminInstances.js'))
        .default);
    app.use('/pl/course/:course_id(\\d+)/course_admin/getting_started', [
        (await import('./pages/instructorCourseAdminGettingStarted/instructorCourseAdminGettingStarted.js')).default,
    ]);
    app.use('/pl/course/:course_id(\\d+)/course_admin/issues', (await import('./pages/instructorIssues/instructorIssues.js')).default);
    app.use('/pl/course/:course_id(\\d+)/course_admin/questions', (await import('./pages/instructorQuestions/instructorQuestions.js')).default);
    app.use('/pl/course/:course_id(\\d+)/ai_generate_editor/:question_id(\\d+)', (await import('./ee/pages/instructorAiGenerateDraftEditor/instructorAiGenerateDraftEditor.js'))
        .default);
    app.use('/pl/course/:course_id(\\d+)/ai_generate_question_drafts', (await import('./ee/pages/instructorAiGenerateDrafts/instructorAiGenerateDrafts.js')).default);
    app.use('/pl/course/:course_id(\\d+)/course_admin/syncs', (await import('./pages/courseSyncs/courseSyncs.js')).default);
    app.use('/pl/course/:course_id(\\d+)/course_admin/topics', (await import('./pages/instructorCourseAdminTopics/instructorCourseAdminTopics.js')).default);
    app.use('/pl/course/:course_id(\\d+)/course_admin/tags', (await import('./pages/instructorCourseAdminTags/instructorCourseAdminTags.js')).default);
    app.use('/pl/course/:course_id(\\d+)/course_admin/file_edit', (await import('./pages/instructorFileEditor/instructorFileEditor.js')).default);
    app.use('/pl/course/:course_id(\\d+)/course_admin/file_view', (await import('./pages/instructorFileBrowser/instructorFileBrowser.js')).default);
    app.use('/pl/course/:course_id(\\d+)/course_admin/file_download', (await import('./pages/instructorFileDownload/instructorFileDownload.js')).default);
    app.use('/pl/course/:course_id(\\d+)/loadFromDisk', (await import('./pages/instructorLoadFromDisk/instructorLoadFromDisk.js')).default);
    app.use('/pl/course/:course_id(\\d+)/jobSequence', (await import('./pages/jobSequence/jobSequence.js')).default);
    app.use('/pl/course/:course_id(\\d+)/grading_job', (await import('./pages/instructorGradingJob/instructorGradingJob.js')).default);
    ...
    app.use('/pl/course/:course_id(\\d+)/copy_public_question', (await import('./pages/instructorCopyPublicQuestion/instructorCopyPublicQuestion.js')).default);
    // Global client files
    app.use('/pl/course/:course_id(\\d+)/clientFilesCourse', (await import('./pages/clientFilesCourse/clientFilesCourse.js')).default);
    // Client files for questions
    app.use('/pl/course/:course_id(\\d+)/question/:question_id(\\d+)/clientFilesCourse', (await import('./pages/clientFilesCourse/clientFilesCourse.js')).default);
    ...
    // Submission files
    app.use('/pl/course/:course_id(\\d+)/question/:question_id(\\d+)/submission/:unsafe_submission_id(\\d+)/file', [
        (await import('./middlewares/selectAndAuthzInstructorQuestion.js')).default,
        (await import('./pages/submissionFile/submissionFile.js')).default(),
    ]);
    // legacy client file paths
    ...
    app.use('/pl/public/course/:course_id(\\d+)/question/:question_id(\\d+)/file_download', (await import('./pages/publicQuestionFileDownload/publicQuestionFileDownload.js')).default);
    app.use('/pl/public/course/:course_id(\\d+)/question/:question_id(\\d+)/preview', (await import('./pages/publicQuestionPreview/publicQuestionPreview.js')).default);
    app.use('/pl/public/course/:course_id(\\d+)/questions', (await import('./pages/publicQuestions/publicQuestions.js')).default);
    app.use('/pl/public/course/:course_id(\\d+)/cacheableElements/:cachebuster', (await import('./pages/elementFiles/elementFiles.js')).default({
        publicQuestionEndpoint: true,
        coreElements: false,
    }));
    app.use('/pl/public/course/:course_id(\\d+)/elements', (await import('./pages/elementFiles/elementFiles.js')).default({
        publicQuestionEndpoint: true,
        coreElements: false,
    }));
    ...
    app.use('/pl/public/course_instance/:course_instance_id(\\d+)/assessment/:assessment_id(\\d+)/questions', (await import('./pages/publicAssessmentQuestions/publicAssessmentQuestions.js')).default);
    // Client files for questions
    app.use('/pl/public/course/:course_id(\\d+)/question/:question_id(\\d+)/clientFilesQuestion', (await import('./pages/clientFilesQuestion/clientFilesQuestion.js')).default({
        publicEndpoint: true,
    }));
    // generatedFiles
    app.use('/pl/public/course/:course_id(\\d+)/question/:question_id(\\d+)/generatedFilesQuestion', (await import('./pages/generatedFilesQuestion/generatedFilesQuestion.js')).default({
        publicEndpoint: true,
    }));
    // Submission files
    app.use('/pl/public/course/:course_id(\\d+)/question/:question_id(\\d+)/submission/:unsafe_submission_id(\\d+)/file', [(await import('./pages/submissionFile/submissionFile.js')).default({ publicEndpoint: true })]);
    //////////////////////////////////////////////////////////////////////
    //////////////////////////////////////////////////////////////////////
    //////////////////////////////////////////////////////////////////////
    // Institution administrator pages ///////////////////////////////////
    if (isEnterprise()) {
        app.use('/pl/institution/:institution_id(\\d+)/admin', (await import('./ee/routers/institutionAdmin.js')).default);
    }
    //////////////////////////////////////////////////////////////////////
    //////////////////////////////////////////////////////////////////////
    //////////////////////////////////////////////////////////////////////
    ...
    app.use('/pl/administrator', asyncHandler(async (req, res, next) => {
    ...
    app.use('/pl/administrator/admins', (await import('./pages/administratorAdmins/administratorAdmins.js')).default);
    app.use('/pl/administrator/settings', (await import('./pages/administratorSettings/administratorSettings.js')).default);
    app.use('/pl/administrator/institutions', (await import('./pages/administratorInstitutions/administratorInstitutions.js')).default);
    app.use('/pl/administrator/courses', (await import('./pages/administratorCourses/administratorCourses.js')).default);
    app.use('/pl/administrator/networks', (await import('./pages/administratorNetworks/administratorNetworks.js')).default);
    app.use('/pl/administrator/workspaces', (await import('./pages/administratorWorkspaces/administratorWorkspaces.js')).default);
    app.use('/pl/administrator/features', (await import('./pages/administratorFeatures/administratorFeatures.js')).default);
    app.use('/pl/administrator/queries', (await import('./pages/administratorQueries/administratorQueries.js')).default);
    app.use('/pl/administrator/query', (await import('./pages/administratorQuery/administratorQuery.js')).default);
    app.use('/pl/administrator/jobSequence', (await import('./pages/jobSequence/jobSequence.js')).default);
    app.use('/pl/administrator/courseRequests', (await import('./pages/administratorCourseRequests/administratorCourseRequests.js')).default);
    app.use('/pl/administrator/batchedMigrations', (await import('./pages/administratorBatchedMigrations/administratorBatchedMigrations.js'))
        .default);
    if (isEnterprise()) {
        app.use('/pl/administrator/institution/:institution_id(\\d+)', (await import('./ee/routers/administratorInstitution.js')).default);
    }
    //////////////////////////////////////////////////////////////////////
    //////////////////////////////////////////////////////////////////////
    //////////////////////////////////////////////////////////////////////
...
export async function startServer() {
    ...
    if (server.getConnections) {
        opentelemetry.createObservableValueGauges(meter, 'http.connections.active', {
            valueType: opentelemetry.ValueType.INT,
            interval: 1000,
        }, () => {
...
export async function stopServer() {
    if (!server)
        throw new Error('cannot stop an undefined server');
    if (!server.listening)
        return;
...
export async function insertDevUser() {
    ...
    const adminSql = 'INSERT INTO administrators (user_id)' +
        ' VALUES ($user_id)' +
...
if (esMain(import.meta) && config.startServer) {
    try {
        ...
        if (config.pyroscopeEnabled) {
            if (!config.pyroscopeServerAddress ||
        ...
        if (config.runMigrations || argv['migrate-and-exit']) {
            await migrations.init([path.join(import.meta.dirname, 'migrations'), SCHEMA_MIGRATIONS_PATH], 'prairielearn');
        ...
        pools.forEach(({ name, pool }) => {
            opentelemetry.createObservableValueGauges(meter, `postgres.pool.${name}.total`, { valueType: opentelemetry.ValueType.INT, interval: 1000 }, () => pool.totalCount);
            opentelemetry.createObservableValueGauges(meter, `postgres.pool.${name}.idle`, { valueType: opentelemetry.ValueType.INT, interval: 1000 }, () => pool.idleCount);
            opentelemetry.createObservableValueGauges(meter, `postgres.pool.${name}.waiting`, { valueType: opentelemetry.ValueType.INT, interval: 1000 }, () => pool.waitingCount);
            const queryCounter = opentelemetry.getObservableCounter(meter, `postgres.pool.${name}.query.count`, { valueType: opentelemetry.ValueType.INT });
            queryCounter.addCallback((observableResult) => {
                observableResult.observe(pool.queryCount);
            });
        });
        // Collect metrics on our code callers.
        opentelemetry.createObservableValueGauges(meter, 'code-caller.pool.size', { valueType: opentelemetry.ValueType.INT, interval: 1000 }, () => codeCaller.getMetrics().size);
        opentelemetry.createObservableValueGauges(meter, 'code-caller.pool.available', { valueType: opentelemetry.ValueType.INT, interval: 1000 }, () => codeCaller.getMetrics().available);
        opentelemetry.createObservableValueGauges(meter, 'code-caller.pool.borrowed', { valueType: opentelemetry.ValueType.INT, interval: 1000 }, () => codeCaller.getMetrics().borrowed);
        opentelemetry.createObservableValueGauges(meter, 'code-caller.pool.pending', { valueType: opentelemetry.ValueType.INT, interval: 1000 }, () => codeCaller.getMetrics().pending);
