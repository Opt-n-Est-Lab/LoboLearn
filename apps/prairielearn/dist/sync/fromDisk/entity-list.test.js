...
describe('determineOperationsForEntities', () => {
    ...
    it('handles adding explicit entities', () => {
        const result = determineOperationsForEntities({
            ...
            existingEntities: [],
            knownNames: new Set(),
            makeImplicitEntity: (name) => ({ name, implicit: true }),
            comparisonProperties: [],
            isInfoCourseValid: true,
            deleteUnused: true,
        });
    ...
    it('handles updating explicit entities', () => {
        const result = determineOperationsForEntities({
            ...
            knownNames: new Set(),
            makeImplicitEntity: (name) => ({ name, heading: name }),
            comparisonProperties: ['heading'],
            isInfoCourseValid: true,
            deleteUnused: true,
        });
...
//# sourceMappingURL=entity-list.test.js.map