...
describe('Auto-test questions in exampleCourse', () => {
    it('has correct topic for all template questions', async () => {
        const questionsWithIncorrectTopics = [];
    ...
    describe('Auto-test questions in exampleCourse', function () {
        ...
        [...qidsExampleCourse, ...templateQuestionQids].forEach((qid) => helperQuestion.autoTestQuestion(locals, qid));
    });
...
//# sourceMappingURL=exampleCourseQuestions.test.js.map