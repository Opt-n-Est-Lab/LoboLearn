...
const infoCourseJsonA = JSON.parse(readFileSync(path.join(courseTemplateDir, infoCoursePath), 'utf-8'));
const infoCourseJsonB = JSON.parse(readFileSync(path.join(courseTemplateDir, infoCoursePath), 'utf-8'));
infoCourseJsonB.title = 'Test Course (Renamed)';
const infoCourseJsonC = JSON.parse(readFileSync(path.join(courseTemplateDir, infoCoursePath), 'utf-8'));
infoCourseJsonC.title = 'Test Course (Renamed Yet Again)';
const infoCourseInstanceJsonA = JSON.parse(readFileSync(path.join(courseTemplateDir, infoCourseInstancePath), 'utf-8'));
const infoCourseInstanceJsonB = JSON.parse(readFileSync(path.join(courseTemplateDir, infoCourseInstancePath), 'utf-8'));
infoCourseInstanceJsonB.longName = 'Fall 2019';
const infoCourseInstanceJsonC = JSON.parse(readFileSync(path.join(courseTemplateDir, infoCourseInstancePath), 'utf-8'));
infoCourseInstanceJsonC.longName = 'Spring 2020';
const infoAssessmentJsonA = JSON.parse(readFileSync(path.join(courseTemplateDir, infoAssessmentPath), 'utf-8'));
const infoAssessmentJsonB = JSON.parse(readFileSync(path.join(courseTemplateDir, infoAssessmentPath), 'utf-8'));
infoAssessmentJsonB.title = 'Homework for file editor test (Renamed)';
const infoAssessmentJsonC = JSON.parse(readFileSync(path.join(courseTemplateDir, infoAssessmentPath), 'utf-8'));
infoAssessmentJsonC.title = 'Homework for file editor test (Renamed Yet Again)';
const questionJsonA = JSON.parse(readFileSync(path.join(courseTemplateDir, questionJsonPath), 'utf-8'));
const questionJsonB = JSON.parse(readFileSync(path.join(courseTemplateDir, questionJsonPath), 'utf-8'));
questionJsonB.title = 'Test question (Renamed)';
const questionJsonC = JSON.parse(readFileSync(path.join(courseTemplateDir, questionJsonPath), 'utf-8'));
            ...
            fs.access(path.join(courseDevDir, fileName), (err) => {
                if (err) {
                    if (err.code === 'ENOENT')
                        ...
                        callback(new Error(`got wrong error: ${err}`));
                }
                else {
...
//# sourceMappingURL=fileEditor.test.js.map