...
import { loadSqlEquiv, queryAsync, queryOneRowAsync, queryValidatedOneRow, queryValidatedRows, } from '@prairielearn/postgres';
...
async function getQuestionUrl(courseInstanceUrl, assessmentInstanceId, questionId) {
    const result = await queryValidatedOneRow(sql.select_instance_questions, {
...
async function prepareGroup() {
    ...
    // Get group roles
    const groupRoles = await queryValidatedRows(sql.select_assessment_group_roles, {
...
//# sourceMappingURL=groupExamRolePermissions.test.js.map