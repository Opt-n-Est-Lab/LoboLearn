...
export function testQuestionPreviews(previewPageInfo, addNumbers, addVectors) {
    const locals = previewPageInfo;
...
export function testFileDownloads(previewPageInfo, downloadFile, shouldAccessClientFilesCourse) {
    const locals = previewPageInfo;
...
export function testElementClientFiles(previewPageInfo, customElement) {
    const locals = previewPageInfo;
    describe('setting up the submission data', function () {
        it('should succeed', function () {
            locals.shouldHaveButtons = ['grade', 'save', 'newVariant'];
...
//# sourceMappingURL=helperQuestionPreview.js.map