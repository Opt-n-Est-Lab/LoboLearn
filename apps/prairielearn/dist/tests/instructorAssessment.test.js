...
describe('Instructor assessment editing', function () {
    ...
    describe('7. edit-question-points form', function () {
        it('should exist', function () {
            elemList = locals.$('#instanceQuestionList td:contains("addNumbers") ~ td button[data-testid="edit-question-points-score-button-points"]');
            assert.lengthOf(elemList, 1);
        });
    ...
    describe('9. edit-question-score-perc form', function () {
        it('should exist', function () {
            elemList = locals.$('#instanceQuestionList td:contains("addNumbers") ~ td button[data-testid="edit-question-points-score-button-score_perc"]');
            assert.lengthOf(elemList, 1);
        });
        it('should have data-bs-content', function () {
            assert.isString(elemList[0].attribs['data-bs-content']);
...
//# sourceMappingURL=instructorAssessment.test.js.map