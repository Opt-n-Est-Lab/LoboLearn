...
describe('Instructor force-breaking variants', () => {
    let assessmentId;
    let partialCredit1AssessmentQuestionId;
    let partialCredit2AssessmentQuestionId;
    let partialCredit1VariantId;
    let partialCredit2VariantId;
    let assessmentStudentUrl;
    before(async () => {
        ...
        partialCredit1AssessmentQuestionId = await queryRow(sql.select_assessment_question, { qid: 'partialCredit1', assessment_id: assessmentId }, IdSchema);
        partialCredit2AssessmentQuestionId = await queryRow(sql.select_assessment_question, { qid: 'partialCredit2', assessment_id: assessmentId }, IdSchema);
    });
    ...
    step('instructor breaks second variant via student instance page', async () => {
        ...
        const instanceQuestion = await queryRow(sql.select_instance_question, { assessment_question_id: partialCredit2AssessmentQuestionId }, IdSchema);
...
//# sourceMappingURL=instructorBreakVariants.test.js.map