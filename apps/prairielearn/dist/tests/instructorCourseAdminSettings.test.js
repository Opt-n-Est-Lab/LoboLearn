...
describe('Editing course settings', () => {
    ...
    step('pull and verify changes', async () => {
        ...
        const courseDevInfo = JSON.parse(await fs.readFile(path.join(courseDevDir, 'infoCourse.json'), 'utf8'));
...
//# sourceMappingURL=instructorCourseAdminSettings.test.js.map