...
function runTest(context) {
    ...
    step('can add multiple users', async () => {
        ...
        helperClient.extractAndSaveCSRFTokenFromDataContent(context, response.$, 'button[data-testid="add-users-button"]');
    ...
    step('can delete all course instance permissions', async () => {
        ...
        assert.isTrue(response.ok);
        helperClient.extractAndSaveCSRFTokenFromDataContent(context, response.$, 'button[data-testid="remove-all-student-data-access-button"]');
        response = await helperClient.fetchCheerio(context.pageUrl, {
            method: 'POST',
            body: new URLSearchParams({
    ...
    step('can delete users with no access', async () => {
        ...
        assert.isTrue(response.ok);
        helperClient.extractAndSaveCSRFTokenFromDataContent(context, response.$, 'button[data-testid="delete-users-with-no-access-button"]');
        response = await helperClient.fetchCheerio(context.pageUrl, {
            method: 'POST',
            body: new URLSearchParams({
    ...
    step('can delete non-owners', async () => {
        ...
        assert.isTrue(response.ok);
        helperClient.extractAndSaveCSRFTokenFromDataContent(context, response.$, 'button[data-testid="delete-non-owners-button"]');
        response = await helperClient.fetchCheerio(context.pageUrl, {
            method: 'POST',
            body: new URLSearchParams({
...
//# sourceMappingURL=courseAdminAccess.test.js.map