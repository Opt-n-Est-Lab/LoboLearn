...
describe('Shared Question Preview', function () {
    ...
    before('Get question IDs from database', async () => {
        for (const testQuestion of testQuestions) {
            testQuestion.id = await sqldb.queryRow(sql.select_question_id, {
    ...
    describe('Public Question Previews', () => {
        ...
        describe('When questions are share_source_publicly but not share_publicly', () => {
            before('Make sure questions have share_source_publicly set but not share_publicly', async () => {
                for (const testQuestion of testQuestions) {
...
//# sourceMappingURL=sharedQuestionPreview.test.js.map