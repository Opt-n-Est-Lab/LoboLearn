...
import { AssessmentModuleSchema, AssessmentSchema, CourseSchema, } from '../../lib/db-types.js';
...
describe('Assessment modules syncing', () => {
    ...
    it('adds a new assessment module', async () => {
        ...
        const syncedAssessmentModules = await util.dumpTableWithSchema('assessment_modules', AssessmentModuleSchema);
        const syncedAssessmentModule = syncedAssessmentModules.find((am) => am.name === newAssessmentModule.name);
    ...
    it('records a warning if two assessment modules have the same name', async () => {
        ...
        const syncedAssessmentModules = await util.dumpTableWithSchema('assessment_modules', AssessmentModuleSchema);
        const syncedAssessmentModule = syncedAssessmentModules.find((as) => as.name === newAssessmentModule2.name);
    ...
    it('uses explicitly-created default assessment module', async () => {
        ...
        const syncedAssessmentModule = syncedAssessmentModules.find((am) => am.name === defaultAssessmentModule.name);
    ...
    it('deletes all assessment modules when none are used', async () => {
        ...
        const remainingAssessmentModules = await util.dumpTableWithSchema('assessment_modules', AssessmentModuleSchema);
...
//# sourceMappingURL=assessmentModulesSync.test.js.map