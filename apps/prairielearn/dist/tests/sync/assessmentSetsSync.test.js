...
import { AssessmentSetSchema, CourseSchema } from '../../lib/db-types.js';
...
describe('Assessment set syncing', () => {
    ...
    it('adds a new assessment set', async () => {
        ...
        const syncedAssessmentSets = await util.dumpTableWithSchema('assessment_sets', AssessmentSetSchema);
    ...
    it('adds default assessment sets if used by assessments but not specified in courseData', async () => {
        ...
        const syncedMachineProblemSet = syncedAssessmentSets.find((as) => as.name === 'Machine Problem');
    ...
    it('deletes all assessment sets when none are used', async () => {
        ...
        const remainingAssessmentSets = await util.dumpTableWithSchema('assessment_sets', AssessmentSetSchema);
...
//# sourceMappingURL=assessmentSetsSync.test.js.map