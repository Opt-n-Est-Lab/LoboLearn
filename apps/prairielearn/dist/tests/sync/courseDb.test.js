    ...
    describe('questions loading', () => {
        ...
        it('errors if two questions share a UUID', async () => {
            await withTempDirectory(async (dir) => {
                ...
                assert.match(infofile.stringifyWarnings(result['question1']), /UUID.*is used in other questions/);
                assert.isFalse(infofile.hasErrors(result['question1']));
                assert.match(infofile.stringifyWarnings(result['question2']), /UUID.*is used in other questions/);
                assert.isFalse(infofile.hasErrors(result['question2']));
...
//# sourceMappingURL=courseDb.test.js.map