...
export function Navbar({
  ...
  return html`
    ...
    <nav class="navbar navbar-dark navbar-expand-md" aria-label="Global navigation" style="background-color: #ba0c2f;">
      <div class="container-fluid">
        <a class="navbar-brand" href="${config.homeUrl}" aria-label="Homepage">
          <span class="navbar-brand-label">LoboLearn</span>
          ...
          ${authz_data?.mode === 'Exam'
            ? html`
                <div class="dropdown-item-text">
                  ...
                  interactions with LoboLearn are limited to your checked-in exam for the
