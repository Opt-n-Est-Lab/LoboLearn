...
const BENCHMARKS: Benchmark[] = [
  // These are high-quality prompts written or reviewed by a LoboLearn expert.
  {
    prompt:
...
async function evaluateGeneratedQuestion({
  ...
  const systemPrompt = [
    'Another LLM has generated a LoboLearn question from the following prompt:',
    '',
    '<prompt>',
    userPrompt
      .split('\n')
    ...
    // generated question, as well as our baseline context about how LoboLearn
