      ...
      <form method="POST">
        ...
        <div class="mb-3">
          ...
          <small id="uidAttributeHelp" class="form-text text-muted">
            ...
            LoboLearn will never try to route email to it. This attribute may change, for
        ...
        <div class="mb-3">
          ...
          <small id="emailAttributeHelp" class="form-text text-muted">
            This attribute should contain the email address of the user. If present, LoboLearn
            will use this to send email to the user.
          </small>
        </div>

        <button class="btn btn-info">Save LoboLearn config</button>
      </form>
