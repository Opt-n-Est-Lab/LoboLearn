      ...
      <form method="POST" class="mb-3 js-configure-form" ${!hasSamlProvider ? 'hidden' : ''}>
        ...
        <div class="mb-3">
          ...
          <small id="ssoLoginUrlHelp" class="form-text text-muted">
            The SAML endpoint URL generated by your Identity Provider. LoboLearn only supports
...
${samlProvider?.certificate ?? '-----BEGIN CERTIFICATE-----\n-----END CERTIFICATE-----'}</textarea
        ...
        <p>
          You must specify a mapping from your Identity Provider's attributes to LoboLearn's user
        ...
        <div class="mb-3">
          ...
          <small id="uidAttributeHelp" class="form-text text-muted">
            ...
            like "jwang@example.com". However, it doesn't have to be an email address; LoboLearn
  ...
  return Modal({
    ...
    body: html`
      <p>
        ...
        yourself, may be unable to log in to LoboLearn.
      </p>
    `,
    footer: html`
