          ...
          <div class="row">
            ...
            <div class="col-10">
              ...
              instance.lti13_course_instance.lineitems_url
                ...
                : html`
                    <p>
                      LoboLearn does not have enough LTI metadata to link assignments and do
                      grade passback.
                    </p>
                    <p>
                      To update our metadata, go back to the LMS and initiate a LoboLearn
  ...
  return html`
    <div class="table-responsive">
      <table class="table table-sm table-hover">
        <thead>
          <tr>
            <th colspan="2" scope="row">LoboLearn Assessment</th>
            <th>Actions</th>
            <th>
              <form method="POST">
...
export function LineitemsInputs(lineitems: Lineitems) {
  const disclaimer = html`
    <details>
      ...
      <p>
        LoboLearn can only poll for assignments in the LMS that are associated with LoboLearn.
      </p>
      <p>
