    ...
    <html lang="en">
      ...
      <body>
        ...
        <main id="content" class="container mb-4">
          <h1>Welcome to LoboLearn</h1>
          <p>
            To finish the integration for your course, you need to connect
            <strong>${courseName}</strong> with a LoboLearn course instance.
          </p>

          ${courses.length === 0
            ? html`<p>
                <strong>
                  You don't have course owner or editor permissions in any LoboLearn courses.
                </strong>
              </p>`
            : html`
                <div class="mb-3">
          ...
          <p>
            <details>
              ...
              <p>
                You must have LoboLearn course <strong>Editor</strong> and course instance
                <strong>Student Data Editor</strong> permissions to link a course.
              </p>
            </details>
          </p>
          <p>
            If you need a new LoboLearn course,
            <a href="/pl/request_course">request one here</a>.
          </p>

          <p>
            If you need a new course instance, create one in LoboLearn first then revisit this
            course linking flow.
          </p>
          <button
            type="button"
          ...
          >
            New here? Learn about LoboLearn terminology
          </button>
        </main>
      </body>
    </html>
  ...
  return html`
    ...
    <html lang="en">
      ...
      <body>
        ...
        <main id="content" class="container mb-4">
          <h1 class="h1">Welcome to LoboLearn</h1>
          <h2 class="h2">... but your course isn't ready yet!</h2>

          <p>An instructor has not yet configured ${courseName} in LoboLearn.</p>
          ...
          ${ltiRoles.includes(STUDENT_ROLE)
            ...
            : html`
                <div class="card">
                  ...
                  <div class="card-body">
                    <p>
                      You do not have the permissions to integrate LoboLearn course instances. An
      ...
      <body>
        ...
        <main id="content" class="container mb-4">
          ...
          <p>
            ...
            LMS, they will be taken directly to your LoboLearn course instance.
          </p>
...
function TerminologyModal() {
  return Modal({
    ...
    title: 'Understanding LoboLearn',
    body: html`
      <p>
        LoboLearn defines a <strong>course</strong> as a collection of questions and course
      ...
      <p>
        For more, see the
        <a href="https://prairielearn.readthedocs.io/" target="_blank">LoboLearn User Guide</a>
      </p>
    `,
  });
}
