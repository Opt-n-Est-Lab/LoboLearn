...
const ConfigSchema = z.object({
  ...
  githubCourseOwner: z.string().default('LoboLearn'),
   ...
   * subscription, or other agreement for the use of LoboLearn Enterprise
   * Edition from LoboLearn, Inc., or if the user is doing local development/testing of features
   * that use Enterprise Edition code. See the license at `ee/LICENSE` for full
   * details.
   */
  isEnterprise: z.boolean().default(false),
  /**
   * Used to sign JWTs that LoboLearn provides to PrairieTest for authentication.
