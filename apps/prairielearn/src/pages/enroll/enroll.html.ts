      ...
      <body>
        ...
        <main id="content" class="container">
          <div class="card mb-4">
            ...
            <div class="card-body">
              <p>
                Your LoboLearn login is currently tied to
              ...
              <p>
                ...
                to LoboLearn from it, it will take over your login again. You might consider
                using different web browsers for that course from your other LoboLearn courses.
              </p>
            </div>
          </div>
        </main>
...
function AddCourseModal({ csrfToken }: { csrfToken: string }) {
  return Modal({
    ...
    body: html`
      <p>Are you sure you want to add this course content to your LoboLearn account?</p>
      <p>
        Adding or removing courses here only affects what is visible to you on LoboLearn. This
...
function RemoveCourseModal({ csrfToken }: { csrfToken: string }) {
  return Modal({
    ...
    body: html`
      <p>Are you sure you want to remove this course content from your LoboLearn account?</p>
      <p>
        Adding or removing courses here only affects what is visible to you on LoboLearn. This
        does not change your university course registration.
      </p>
