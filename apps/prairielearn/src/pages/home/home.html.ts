...
export function Home({
  ...
  return PageLayout({
    ...
    content: html`
      <h1 class="visually-hidden">LoboLearn Homepage</h1>
      ${ActionsHeader()}
...
function DevModeCard() {
  ...
  return html`
    <div class="card mb-4">
      ...
      <div class="card-body">
        <p>
          LoboLearn is running in Development Mode. Click the
        ...
        <p class="mb-0">
          See the
          <a href="https://prairielearn.readthedocs.io">LoboLearn documentation</a>
          ...
          : config.devMode
            ? html`
                <div class="card-body">
                  ...
                  <strong>"LoboLearn"</strong> in the top left corner to come back to this page.
                </div>
              `
            : html`
                <div class="card-body">
