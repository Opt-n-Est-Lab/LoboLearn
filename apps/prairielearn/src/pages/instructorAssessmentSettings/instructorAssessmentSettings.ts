...
router.get(
  ...
  asyncHandler(async (req, res) => {
    ...
    if (res.locals.course.example_course) {
      ...
      assessmentGHLink = `https://github.com/LoboLearn/LoboLearn/tree/master/exampleCourse/courseInstances/${res.locals.course_instance.short_name}/assessments/${res.locals.assessment.tid}`;
