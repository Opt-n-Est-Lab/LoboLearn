  ...
  return PageLayout({
    ...
    content: html`
      ...
      <div class="card mb-4">
        ...
        <div class="card-footer">
          <small>
            ...
            <em>effective</em> values below allow you to view LoboLearn as if you had a different
            <em>course role</em> or as if you were a specific other person with a different
            <em>UID</em>. This can be used to test out how LoboLearn will look from different
      ...
      <div class="card mb-4">
        ...
        <div class="card-footer">
          <small>
            Changing your effective user identity to another person allows you to see LoboLearn
      ...
      <div class="card mb-4">
        ...
        <div class="card-footer">
          <small>
            ...
            course content in LoboLearn. It is specific to this course, so you can be an Editor
            ...
            <div class="card mb-4">
              ...
              <div class="card-footer">
                <small>
                  ...
                  view and edit student data in LoboLearn. It is specific to this course
