            ...
            <div class="card mb-4">
              ...
              <div class="card-body">
                <p>
                  ...
                  websites to embed LoboLearn assessments within them. LoboLearn acts as a
                ...
                <p>
                  <strong>
                    This version of LTI is deprecated. Check with LoboLearn admins before
...
function LtiLinkTargetsCard({
  ...
  return html`
    <div class="card mb-4">
      ...
      <div class="card-body">
        <p>
          LTI links connect an assessment from your LMS directly into a LoboLearn assessment.
          This is required for LoboLearn to update scores in your LMS.
        </p>
        <p class="mb-0">
