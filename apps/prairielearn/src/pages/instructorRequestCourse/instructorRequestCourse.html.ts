  ...
  return html`
    <div class="card mb-4">
      ...
      <form class="question-form" name="course-request" method="POST">
        <div class="card-body">
          <p>
            This form is for instructors who want to create a new course on LoboLearn. Students
            should <strong>not</strong> submit this form and should instead use the "Add or remove
            courses" button on the LoboLearn homepage. Teaching assistants and course staff are
          ...
          <div class="mb-3">
            <label class="form-label" id="cr-referral-source-label" for="cr-referral-source">
              How did you hear about LoboLearn?
            </label>
            <select
              class="form-select"
            ...
            >
              ...
              <option value="I've used LoboLearn before">I've used LoboLearn before</option>
            ...
            />
            <small class="form-text text-muted">
              This information helps us understand how people find out about LoboLearn. Thank you
              for sharing!
            </small>
          </div>
          <div class="mb-3">
