    ...
    content: html`
      ...
      <aside>
        <p class="text-right small border-top mt-5 pt-3">
          Want to help make LoboLearn better? It's open source and contributions are welcome
          <a href="https://github.com/LoboLearn/LoboLearn" target="_blank">on GitHub</a>!
        </p>
      </aside>
    `,
  });
