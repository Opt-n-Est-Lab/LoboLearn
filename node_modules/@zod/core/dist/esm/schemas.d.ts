...
export interface $ZodTypeDef {
    type: "string" | "number" | "int" | "boolean" | "bigint" | "symbol" | "null" | "undefined" | "void" | "never" | "any" | "unknown" | "date" | "object" | "interface" | "record" | "file" | "array" | "tuple" | "union" | "intersection" | "map" | "set" | "enum" | "literal" | "nullable" | "optional" | "nonoptional" | "success" | "transform" | "default" | "catch" | "nan" | "pipe" | "readonly" | "template_literal" | "promise" | "lazy" | "custom";
...
export interface $ZodArrayInternals<T extends $ZodType = $ZodType> extends $ZodTypeInternals<T["_zod"]["output"][], T["_zod"]["input"][]> {
    def: $ZodArrayDef<T>;
    isst: errors.$ZodIssueInvalidType;
}
...
export type $InferInterfaceOutput<T extends $ZodLooseShape, Params extends $ZodInterfaceNamedParams> = string extends keyof T ? object : {} extends T ? object : util.Flatten<{
    -readonly [k in Params["optional"]]?: T[k]["_zod"]["output"];
} & {
    -readonly [k in Exclude<keyof T, Params["optional"]>]: T[k]["_zod"]["output"];
} & Params["extra"]>;
export type $InferInterfaceInput<T extends $ZodLooseShape, Params extends $ZodInterfaceNamedParams> = string extends keyof T ? Record<string, unknown> : $ZodInterfaceNamedParams extends Params ? Record<string, unknown> : util.Flatten<{
...
export interface $ZodInterfaceInternals<Shape extends Readonly<$ZodLooseShape> = Readonly<$ZodLooseShape>, Params extends $ZodInterfaceNamedParams = $ZodInterfaceNamedParams> extends $ZodObjectLikeInternals<$InferInterfaceOutput<Shape, Params>, $InferInterfaceInput<Shape, Params>> {
    subtype: "interface";
...
export interface $ZodInterface<Shape extends Readonly<$ZodLooseShape> = Readonly<$ZodLooseShape>, Params extends $ZodInterfaceNamedParams = {
    optional: string;
    defaulted: string;
    extra: Record<string, unknown>;
}> extends $ZodType {
...
export type $InferObjectOutput<T extends $ZodShape, Extra extends Record<string, unknown>> = {} extends T ? object : util.Flatten<OptionalOutProps<T> & RequiredOutProps<T>> & Extra;
...
export type $InferObjectInput<T extends $ZodShape, Extra extends Record<string, unknown>> = util.Flatten<({} extends T ? object : OptionalInProps<T> & RequiredInProps<T>) & Extra>;
export interface $ZodObjectDef<Shape extends $ZodShape = $ZodShape> extends $ZodObjectLikeDef<Shape> {
    type: "object";
    shape: Shape;
}
export interface $ZodObjectInternals<Shape extends $ZodShape = $ZodShape, Extra extends Record<string, unknown> = Record<string, unknown>> extends $ZodObjectLikeInternals<$InferObjectOutput<Shape, Extra>, $InferObjectInput<Shape, Extra>> {
    subtype: "object";
    def: $ZodObjectDef<Shape>;
    extra: Extra;
}
export interface $ZodObject<Shape extends $ZodShape = $ZodShape, Extra extends Record<string, unknown> = Record<string, unknown>> extends $ZodType {
...
export interface $ZodUnionInternals<T extends readonly $ZodType[] = readonly $ZodType[]> extends $ZodTypeInternals<T[number]["_zod"]["output"], T[number]["_zod"]["input"]> {
    def: $ZodUnionDef<T>;
...
export interface $ZodIntersectionInternals<A extends $ZodType = $ZodType, B extends $ZodType = $ZodType> extends $ZodTypeInternals<A["_zod"]["output"] & B["_zod"]["output"], A["_zod"]["input"] & B["_zod"]["input"]> {
...
] ? Tail["_zod"]["qin"] extends "true" ? [...TupleInputTypeWithOptionals<Prefix>, Tail["_zod"]["input"]?] : TupleInputTypeNoOptionals<T> : [];
...
type TupleOutputTypeWithOptionals<T extends util.TupleItems> = T extends readonly [
    ...infer Prefix extends $ZodType[],
    infer Tail extends $ZodType
] ? Tail["_zod"]["qout"] extends "true" ? [...TupleOutputTypeWithOptionals<Prefix>, Tail["_zod"]["output"]?] : TupleOutputTypeNoOptionals<T> : [];
...
export interface $ZodRecordInternals<Key extends $ZodRecordKey = $ZodRecordKey, Value extends $ZodType = $ZodType> extends $ZodTypeInternals<Record<Key["_zod"]["output"], Value["_zod"]["output"]>, Record<Key["_zod"]["input"], Value["_zod"]["input"]>> {
    def: $ZodRecordDef;
...
export interface $ZodMapInternals<Key extends $ZodType = $ZodType, Value extends $ZodType = $ZodType> extends $ZodTypeInternals<Map<Key["_zod"]["output"], Value["_zod"]["output"]>, Map<Key["_zod"]["input"], Value["_zod"]["input"]>> {
    def: $ZodMapDef;
...
export interface $ZodSetInternals<T extends $ZodType = $ZodType> extends $ZodTypeInternals<Set<T["_zod"]["output"]>, Set<T["_zod"]["input"]>> {
    def: $ZodSetDef;
    isst: errors.$ZodIssueInvalidType;
}
...
export interface $ZodEnumInternals<T extends util.EnumLike = util.EnumLike> extends $ZodTypeInternals<$InferEnumOutput<T>, $InferEnumInput<T>> {
    def: $ZodEnumDef<T>;
    /** @deprecated Internal API, use with caution (not deprecated) */
    values: util.PrimitiveSet;
    /** @deprecated Internal API, use with caution (not deprecated) */
...
export interface $ZodOptionalInternals<T extends $ZodType = $ZodType> extends $ZodTypeInternals<T["_zod"]["output"] | undefined, T["_zod"]["input"] | undefined> {
...
export interface $ZodNullableInternals<T extends $ZodType = $ZodType> extends $ZodTypeInternals<T["_zod"]["output"] | null, T["_zod"]["input"] | null> {
...
export interface $ZodDefaultInternals<T extends $ZodType = $ZodType> extends $ZodTypeInternals<util.NoUndefined<T["_zod"]["output"]>, T["_zod"]["input"] | undefined> {
    def: $ZodDefaultDef<T>;
    qin: "true";
    isst: never;
    values: T["_zod"]["values"];
...
export interface $ZodNonOptionalInternals<T extends $ZodType = $ZodType> extends $ZodTypeInternals<util.NoUndefined<T["_zod"]["output"]>, util.NoUndefined<T["_zod"]["input"]>> {
...
export interface $ZodSuccessInternals<T extends $ZodType = $ZodType> extends $ZodTypeInternals<boolean, T["_zod"]["input"]> {
    def: $ZodSuccessDef;
    isst: never;
}
...
export interface $ZodCatchInternals<T extends $ZodType = $ZodType> extends $ZodTypeInternals<T["_zod"]["output"], util.Loose<T["_zod"]["input"]>> {
    def: $ZodCatchDef;
    qin: T["_zod"]["qin"];
    qout: T["_zod"]["qout"];
    isst: never;
...
export interface $ZodPipeInternals<A extends $ZodType = $ZodType, B extends $ZodType = $ZodType> extends $ZodTypeInternals<B["_zod"]["output"], A["_zod"]["input"]> {
    def: $ZodPipeDef<A, B>;
    isst: never;
...
export interface $ZodReadonlyInternals<T extends $ZodType = $ZodType> extends $ZodTypeInternals<util.MakeReadonly<T["_zod"]["output"]>, util.MakeReadonly<T["_zod"]["input"]>> {
    def: $ZodReadonlyDef;
    qin: T["_zod"]["qin"];
    qout: T["_zod"]["qout"];
    isst: never;
...
type AppendToTemplateLiteral<Template extends string, Suffix extends $LiteralPart | $ZodType> = Suffix extends $LiteralPart ? `${Template}${UndefinedToEmptyString<Suffix>}` : Suffix extends $ZodType ? `${Template}${UndefinedToEmptyString<$LiteralPart & Suffix["_zod"]["output"]>}` : never;
export type $PartsToTemplateLiteral<Parts extends $TemplateLiteralPart[]> = [] extends Parts ? `` : Parts extends [...infer Rest extends $TemplateLiteralPart[], infer Last extends $TemplateLiteralPart] ? AppendToTemplateLiteral<$PartsToTemplateLiteral<Rest>, Last> : never;
...
export interface $ZodPromiseInternals<T extends $ZodType = $ZodType> extends $ZodTypeInternals<T["_zod"]["output"], util.MaybeAsync<T["_zod"]["input"]>> {
    def: $ZodPromiseDef;
    isst: never;
}
...
export interface $ZodLazyInternals<T extends $ZodType = $ZodType> extends $ZodTypeInternals<T["_zod"]["output"], T["_zod"]["input"]> {
    def: $ZodLazyDef;
    isst: never;
    _getter: T;
