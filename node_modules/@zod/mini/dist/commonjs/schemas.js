...
function any(params) {
    return core._any(exports.ZodMiniAny, params);
}
...
function unknown(params) {
    return core._unknown(exports.ZodMiniUnknown, params);
}
...
exports.ZodMiniObjectLike = core.$constructor("ZodMiniObjectLike", (inst, def) => {
...
exports.ZodMiniInterface = core.$constructor("ZodMiniInterface", (inst, def) => {
    core.$ZodInterface.init(inst, def);
    exports.ZodMiniType.init(inst, def);
});
function _interface(shape, params, Class = exports.ZodMiniInterface) {
...
function strictInterface(shape, params) {
    ...
    return new exports.ZodMiniInterface(def);
}
// looseInterface
...
function extend(schema, shape) {
    ...
    if (schema instanceof exports.ZodMiniInterface) {
        return core_1.util.mergeObjectLike(schema, _interface(shape));
    }
    if (schema instanceof exports.ZodMiniObject)
...
function partial(schema, mask) {
    return core_1.util.partialObjectLike(exports.ZodMiniOptional, schema, mask);
}
function required(schema, mask) {
    return core_1.util.requiredObjectLike(exports.ZodMiniNonOptional, schema, mask);
}
