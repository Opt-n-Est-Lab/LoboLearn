...
export declare function any(params?: string | core.$ZodAnyParams): ZodMiniAny;
...
export declare function unknown(params?: string | core.$ZodUnknownParams): ZodMiniUnknown;
...
export declare function date(params?: string | core.$ZodDateParams): ZodMiniDate;
...
export declare function array<T extends SomeType>(element: T, params?: core.$ZodArrayParams): ZodMiniArray<T>;
export interface ZodMiniObjectLike<out O = object, out I = object> extends ZodMiniType {
    _zod: core.$ZodObjectLikeInternals<O, I>;
}
export declare const ZodMiniObjectLike: core.$constructor<ZodMiniObjectLike>;
export declare function keyof<T extends ZodMiniObject>(schema: T): ZodMiniLiteral<keyof T["_zod"]["def"]["shape"]>;
export declare function keyof<T extends ZodMiniInterface>(schema: T): ZodMiniLiteral<keyof T["_zod"]["output"]>;
export interface ZodMiniInterface<Shape extends core.$ZodLooseShape = core.$ZodLooseShape, Params extends core.$ZodInterfaceNamedParams = {
...
export declare const ZodMiniInterface: core.$constructor<ZodMiniInterface>;
declare function _interface<T extends core.$ZodLooseShape>(shape: T, params?: core.$ZodInterfaceParams, Class?: util.Constructor<ZodMiniInterface>): ZodMiniInterface<util.CleanInterfaceShape<T>, util.InitInterfaceParams<T, {}>>;
export { _interface as interface };
export declare function strictInterface<T extends core.$ZodLooseShape>(shape: T, params?: core.$ZodInterfaceParams): ZodMiniInterface<util.CleanInterfaceShape<T>, util.InitInterfaceParams<T, {}>>;
export declare function looseInterface<T extends core.$ZodLooseShape>(shape: T, params?: core.$ZodInterfaceParams): ZodMiniInterface<util.CleanInterfaceShape<T>, util.InitInterfaceParams<T, Record<string, unknown>>>;
export interface ZodMiniObject<Shape extends core.$ZodShape = core.$ZodShape, Extra extends Record<string, unknown> = Record<string, unknown>> extends ZodMiniType {
    _zod: core.$ZodObjectInternals<Shape, Extra>;
}
export declare const ZodMiniObject: core.$constructor<ZodMiniObject>;
export declare function object<T extends core.$ZodShape = Record<never, SomeType>>(shape?: T, params?: core.$ZodObjectLikeParams): ZodMiniObject<T, {}>;
export declare function strictObject<T extends core.$ZodShape>(shape: T, params?: core.$ZodObjectParams): ZodMiniObject<T, {}>;
export declare function looseObject<T extends core.$ZodShape>(shape: T, params?: core.$ZodObjectParams): ZodMiniObject<T, {
    [k: string]: unknown;
}>;
export declare function extend<T extends ZodMiniInterface, U extends ZodMiniInterface>(a: T, b: U): ZodMiniInterface<util.Extend<T["_zod"]["def"]["shape"], U["_zod"]["def"]["shape"]>, util.MergeInterfaceParams<T, U>>;
export declare function extend<T extends ZodMiniObject, U extends ZodMiniObject>(a: T, b: U): ZodMiniObject<util.Extend<T["_zod"]["def"]["shape"], U["_zod"]["def"]["shape"]>, U["_zod"]["extra"] & T["_zod"]["extra"]>;
export declare function extend<T extends ZodMiniInterface, U extends core.$ZodLooseShape>(a: T, b: U): ZodMiniInterface<util.ExtendInterfaceShape<T["_zod"]["def"]["shape"], U>, util.ExtendInterfaceParams<T, U>>;
export declare function extend<T extends ZodMiniObject, U extends core.$ZodLooseShape>(a: T, b: U): ZodMiniObject<util.Extend<T["_zod"]["def"]["shape"], U>, T["_zod"]["extra"]>;
export declare function merge<T extends ZodMiniObjectLike, U extends core.$ZodLooseShape>(schema: T, shape: U): T["_zod"]["def"]["type"] extends "interface" ? ZodMiniInterface<util.Extend<T["_zod"]["def"]["shape"], U["_zod"]["def"]["shape"]>, {
...
export declare function pick<T extends ZodMiniObjectLike, M extends util.Exactly<util.Mask<keyof T["_zod"]["def"]["shape"]>, M>>(schema: T, mask: M): T["_zod"]["def"]["type"] extends "interface" ? ZodMiniInterface<util.Flatten<Pick<T["_zod"]["def"]["shape"], keyof T["_zod"]["def"]["shape"] & keyof M>>, {
    optional: Extract<T["_zod"]["optional"], keyof M>;
    defaulted: Extract<T["_zod"]["defaulted"], keyof M>;
    extra: T["_zod"]["extra"];
}> : ZodMiniObject<util.Flatten<Pick<T["_zod"]["def"]["shape"], keyof T["_zod"]["def"]["shape"] & keyof M>>, T["_zod"]["extra"]>;
export declare function omit<T extends ZodMiniObjectLike, const M extends util.Exactly<util.Mask<keyof T["_zod"]["def"]["shape"]>, M>>(schema: T, mask: M): T["_zod"]["def"]["type"] extends "interface" ? ZodMiniInterface<util.Flatten<Omit<T["_zod"]["def"]["shape"], keyof M>>, {
...
export declare function partial<T extends ZodMiniObjectLike>(schema: T): T["_zod"]["def"]["type"] extends "interface" ? ZodMiniInterface<{
...
export declare function partial<T extends ZodMiniObjectLike, M extends util.Exactly<util.Mask<keyof T["_zod"]["def"]["shape"]>, M>>(schema: T, mask: M): T["_zod"]["def"]["type"] extends "interface" ? ZodMiniInterface<util.Extend<T["_zod"]["def"]["shape"], {
    ...
    [k in keyof T["_zod"]["def"]["shape"]]: k extends keyof M ? ZodMiniOptional<T["_zod"]["def"]["shape"][k]> : T["_zod"]["def"]["shape"][k];
}, T["_zod"]["extra"]>;
export declare function required<T extends {
    _zod: {
        subtype: "object";
    };
} & ZodMiniObject>(schema: T): ZodMiniObject<{
...
} & ZodMiniObject, M extends util.Exactly<util.Mask<keyof T["_zod"]["def"]["shape"]>, M>>(schema: T, mask: M): ZodMiniObject<util.Extend<T["_zod"]["def"]["shape"], {
...
} & ZodMiniInterface>(schema: T): ZodMiniInterface<{
    [k in keyof T["_zod"]["def"]["shape"]]: ZodMiniNonOptional<T["_zod"]["def"]["shape"][k]>;
}, {
    optional: never;
    defaulted: T["_zod"]["defaulted"];
...
} & ZodMiniInterface, M extends util.Mask<keyof T["_zod"]["output"]>>(schema: T, mask: M): ZodMiniInterface<util.Extend<T["_zod"]["def"]["shape"], {
    [k in keyof M & keyof T["_zod"]["def"]["shape"]]: ZodMiniNonOptional<T["_zod"]["def"]["shape"][k]>;
}>, {
    optional: Exclude<T["_zod"]["optional"], keyof M>;
    defaulted: T["_zod"]["defaulted"];
...
export declare function union<const T extends readonly SomeType[]>(options: T, params?: core.$ZodUnionParams): ZodMiniUnion<T>;
...
export declare function discriminatedUnion<Types extends [$ZodTypeDiscriminable, ...$ZodTypeDiscriminable[]]>(options: Types, params?: core.$ZodDiscriminatedUnionParams): ZodMiniDiscriminatedUnion<Types>;
...
export declare function intersection<T extends SomeType, U extends SomeType>(left: T, right: U, params?: core.$ZodIntersectionParams): ZodMiniIntersection<T, U>;
...
export declare function tuple<T extends readonly [SomeType, ...SomeType[]]>(items: T, params?: core.$ZodTupleParams): ZodMiniTuple<T, null>;
export declare function tuple<T extends readonly [SomeType, ...SomeType[]], Rest extends SomeType>(items: T, rest: Rest, params?: core.$ZodTupleParams): ZodMiniTuple<T, Rest>;
export declare function tuple(items: [], params?: core.$ZodTupleParams): ZodMiniTuple<[], null>;
...
export declare function record<Key extends core.$ZodRecordKey, Value extends SomeType>(keyType: Key, valueType: Value, params?: core.$ZodRecordParams): ZodMiniRecord<Key, Value>;
...
export declare function map<Key extends SomeType, Value extends SomeType>(keyType: Key, valueType: Value, params?: core.$ZodMapParams): ZodMiniMap<Key, Value>;
...
export declare function set<Value extends SomeType>(valueType: Value, params?: core.$ZodSetParams): ZodMiniSet<Value>;
...
declare function _enum<const T extends string[]>(values: T, params?: core.$ZodEnumParams): ZodMiniEnum<util.ToEnum<T[number]>>;
declare function _enum<T extends util.EnumLike>(entries: T, params?: core.$ZodEnumParams): ZodMiniEnum<T>;
 ...
 * ```
 */
export declare function nativeEnum<T extends util.EnumLike>(entries: T, params?: core.$ZodEnumParams): ZodMiniEnum<T>;
...
export declare function literal<const T extends Array<util.Literal>>(value: T, params?: core.$ZodLiteralParams): ZodMiniLiteral<T[number]>;
export declare function literal<const T extends util.Literal>(value: T, params?: core.$ZodLiteralParams): ZodMiniLiteral<T>;
...
export declare function transform<I = unknown, O = I>(fn: (input: I, ctx: core.ParsePayload) => O, params?: core.$ZodTransformParams): ZodMiniTransform<Awaited<O>, I>;
...
export declare function optional<T extends SomeType>(innerType: T, params?: core.$ZodOptionalParams): ZodMiniOptional<T>;
...
export declare function nullable<T extends SomeType>(innerType: T, params?: core.$ZodNullableParams): ZodMiniNullable<T>;
...
export declare function _default<T extends SomeType>(innerType: T, defaultValue: util.NoUndefined<core.output<T>> | (() => util.NoUndefined<core.output<T>>), params?: core.$ZodDefaultParams): ZodMiniDefault<T>;
...
export declare function nonoptional<T extends SomeType>(innerType: T, params?: core.$ZodNonOptionalParams): ZodMiniNonOptional<T>;
...
export declare function success<T extends SomeType>(innerType: T, params?: core.$ZodSuccessParams): ZodMiniSuccess<T>;
...
declare function _catch<T extends SomeType>(innerType: T, catchValue: core.output<T> | ((ctx: core.$ZodCatchCtx) => core.output<T>), params?: core.$ZodCatchParams): ZodMiniCatch<T>;
...
export declare function pipe<const A extends core.$ZodType, B extends core.$ZodType<unknown, core.output<A>> = core.$ZodType<unknown, core.output<A>>>(in_: A, out: B | core.$ZodType<unknown, core.output<A>>, params?: core.$ZodPipeParams): ZodMiniPipe<A, B>;
...
export declare function readonly<T extends SomeType>(innerType: T, params?: core.$ZodReadonlyParams): ZodMiniReadonly<T>;
...
export declare function templateLiteral<const Parts extends core.$TemplateLiteralPart[]>(parts: Parts, params?: core.$ZodTemplateLiteralParams): ZodMiniTemplateLiteral<core.$PartsToTemplateLiteral<Parts>>;
...
export declare function promise<T extends SomeType>(innerType: T, params?: core.$ZodPromiseParams): ZodMiniPromise<T>;
...
export declare const stringbool: (_params?: core.$ZodStringBoolParams) => ZodMiniPipe<ZodMiniUnknown, ZodMiniBoolean<boolean>>;
