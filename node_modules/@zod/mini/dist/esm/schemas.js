...
export function any(params) {
    return core._any(ZodMiniAny, params);
}
...
export function unknown(params) {
    return core._unknown(ZodMiniUnknown, params);
}
...
export const ZodMiniObjectLike = /*@__PURE__*/ core.$constructor("ZodMiniObjectLike", (inst, def) => {
...
export const ZodMiniInterface = /*@__PURE__*/ core.$constructor("ZodMiniInterface", (inst, def) => {
...
export function discriminatedUnion(options, params) {
