...
function hasPragma(text) {
  var _a, _b;
  const commentLineRegex = new RegExp("^\\s*(#(?<comment>.*))?$", "gm");
  let lastIndex = -1;
  for (; ; ) {
    ...
    const comment = (_b = (_a = match.groups) == null ? void 0 : _a.comment) == null ? void 0 : _b.trim();
    if (comment == null) {
      continue;
    }
...
const getFormatDockerfileContents = () => __async(void 0, null, function* () {
  if (!formatDockerfileContents_) {
    const dockerfmt = yield import('@reteps/dockerfmt');
...
const shParser = {
  ...
  parse(_0, _1) {
    return __async(this, arguments, function* (text, {
      ...
      /** TODO: support {@link LangVariant.LangAuto} */
      // eslint-disable-line sonarjs/todo-tag
      variant,
      stopAt,
      recoverErrors
    }) {
      return shSyntax.processor(text, {
        filepath,
        keepComments,
        variant,
        stopAt,
...
const shPrinter = {
  ...
  print(_0, _1) {
    return __async(this, arguments, function* (path, {
      ...
      return shSyntax.processor(path.node, {
        originalText,
        filepath,
        keepComments,
        variant,
...
const options = {
  ...
  variant: {
    ...
    choices: [
      {
        value: shSyntax.LangVariant.LangBash,
        description: [
      ...
      {
        value: shSyntax.LangVariant.LangPOSIX,
        description: [
      ...
      {
        value: shSyntax.LangVariant.LangMirBSDKorn,
        description: [
      ...
      {
        value: shSyntax.LangVariant.LangBats,
        description: [
      ...
      {
        value: shSyntax.LangVariant.LangAuto,
        description: [
...
exports.ShSyntaxParseError = ShSyntaxParseError;
