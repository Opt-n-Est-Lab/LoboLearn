...
const observableCounterCache = new WeakMap();
const observableUpDownCounterCache = new WeakMap();
const observableGaugeCache = new WeakMap();
function getCachedMetric(cache, meter, name, create) {
...
export async function instrumentedWithMetrics(meter, name, fn, done) {
