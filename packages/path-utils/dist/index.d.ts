 ...
 * otherwise.
 */
export declare function contains(parentPath: string, childPath: string, includeSelf?: boolean): boolean;
/**
 ...
 * otherwise.
 */
export declare function isContainedRelativePath(relPath: string, includeSelf?: boolean): boolean;
