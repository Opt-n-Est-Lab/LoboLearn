 ...
 * otherwise.
 */
export function contains(parentPath, childPath, includeSelf = true) {
    return isContainedRelativePath(path.relative(parentPath, path.resolve(parentPath, childPath)), includeSelf);
}
/**
 ...
 * otherwise.
 */
export function isContainedRelativePath(relPath, includeSelf = true) {
